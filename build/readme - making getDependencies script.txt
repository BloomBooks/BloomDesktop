...
<your path to buildupdate.rb>\buildupdate.rb -t bt392 -f getDependencies-windows.sh -r ..

Explanation:

"-t bt392" points at the configuration that tracks this branch (in this case, the version 2 branch)
