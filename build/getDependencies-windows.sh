...
copy_auto http://build.palaso.org/guestAuth/repository/download/Libpalaso_PalasoWin32masterNostrongnameContinuous/latest.lastSuccessful/MarkdownDeep.dll ../lib/dotnet/MarkdownDeep.dll
