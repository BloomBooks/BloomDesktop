...
# project=Bloom
# build=Bloom-4.8-CSBetaInternal-Continuous
# root_dir=..
...
# *** Results ***
# build: Bloom-4.8-CSBetaInternal-Continuous (Bloom_Bloom48CSBetaInternalContinuous)
# project: Bloom
# URL: https://build.palaso.org/viewType.html?buildTypeId=Bloom_Bloom48CSBetaInternalContinuous
