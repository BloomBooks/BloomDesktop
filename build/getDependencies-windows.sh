...
# project=Bloom
# build=Bloom-6.0-BetaInternal-Continuous
# root_dir=..
...
# *** Results ***
# build: Bloom-6.0-BetaInternal-Continuous (Bloom_Bloom60BetaInternalContinuous)
# project: Bloom
# URL: https://build.palaso.org/buildConfiguration/Bloom_Bloom60BetaInternalContinuous?mode=builds
# VCS: https://github.com/BloomBooks/BloomDesktop.git [Version6.0]
# dependencies:
...
# [3] build: Bloom Help 6.0 (Bloom_Help_BloomHelp60)
#     project: Help
#     URL: https://build.palaso.org/buildConfiguration/Bloom_Help_BloomHelp60?mode=builds
#     clean: false
#     revision: latest.lastSuccessful
#     paths: {"*.chm"=>"DistFiles"}
...
copy_auto https://build.palaso.org/guestAuth/repository/download/Bloom_Help_BloomHelp60/latest.lastSuccessful/Bloom.chm ../DistFiles/Bloom.chm
