...
copy_auto http://build.palaso.org/guestAuth/repository/download/bt396/latest.lastSuccessful/FirefoxDependencies.zip ../Downloads/FirefoxDependencies.zip
...
copy_auto http://build.palaso.org/guestAuth/repository/download/Bloom_Help_BloomHelp52/latest.lastSuccessful/Bloom.chm ../DistFiles/Bloom.chm
