...
# project=Bloom
# build=Bloom-Geckofx60-Linux64-Continuous
# root_dir=..
# Auto-generated by http://github.com/chrisvire/BuildUpdate.
...
# *** Results ***
# build: Bloom-Geckofx60-Linux64-Continuous (Bloom_BloomGeckfx60Linux64Continuous)
# project: Bloom
# URL: http://build.palaso.org/viewType.html?buildTypeId=Bloom_BloomGeckfx60Linux64Continuous
...
#     VCS: http://github.com/BloomBooks/YouTrackSharp.git [LinuxCompatible]
...
#     VCS: http://github.com/mozilla/pdf.js.git [gh-pages]
...
#     VCS: http://github.com/sillsdev/l10nsharp [master]
...
#     VCS: http://github.com/sillsdev/pdfDroplet [master]
...
#     VCS: http://github.com/BloomBooks/TidyManaged.git [master]
...
#     VCS: http://github.com/sillsdev/XliffForHtml [refs/heads/master]
...
#     VCS: http://github.com/sillsdev/libpalaso.git [master]
...
copy_auto http://build.palaso.org/guestAuth/repository/download/GeckofxHtmlToPdf_GeckofxHtmlToPdfXenial64Geckofx60continuous/latest.lastSuccessful/GeckofxHtmlToPdf.exe ../lib/dotnet/GeckofxHtmlToPdf.exe
copy_auto http://build.palaso.org/guestAuth/repository/download/GeckofxHtmlToPdf_GeckofxHtmlToPdfXenial64Geckofx60continuous/latest.lastSuccessful/GeckofxHtmlToPdf.exe.config ../lib/dotnet/GeckofxHtmlToPdf.exe.config
