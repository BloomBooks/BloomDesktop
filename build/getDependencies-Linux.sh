...
copy_auto http://build.palaso.org/guestAuth/repository/download/Libpalaso_PalasoLinux64masterContinuous/bloom-4.7.tcbuildtag/DialogAdapters.dll ../lib/dotnet/DialogAdapters.dll
