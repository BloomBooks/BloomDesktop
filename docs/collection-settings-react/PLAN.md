...
and `WorkspaceView.OpenLegacySettingsDialog` go away; route `common/showSettingsDialog` and
`CheckForInvalidBranding` to the React dialog; mark the unused `CollectionSettingsDialog.*` xlf
