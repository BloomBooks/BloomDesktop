...
1. **Read the state.**
   ...
   - `docs/retire-ckeditor/PLAN.md` — the staged plan (Stages 0–6). Authoritative for *what* to
     do. §10 holds the settled decisions and what the first review changed — **do not re-litigate
     anything settled there**; if you think a settled point is wrong, say so explicitly to the
     user rather than quietly changing course. §11 records what BL-6681 itself asks for, and what
     on it is already obsolete.
