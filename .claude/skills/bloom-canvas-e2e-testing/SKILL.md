...
(`component-test` skill) or for the BloomE2E suite that launches its own `Bloom.exe`
(`add-e2e-test` skill).
...
commands are safe and how `winformsUia.ps1` drives a picker when one is unavoidable.
