...
while IFS= read -r f; do
  case "$f" in
    ...
    supabase/migrations/*|supabase/tests/*|supabase/schemas/*|supabase/config.toml|supabase/snippets/*|supabase/.gitignore|build/regen-init-migration.sh) echo "$f" >> "$OUT/g2.txt" ;;
