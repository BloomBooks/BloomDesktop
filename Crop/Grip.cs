...
namespace Crop
{
	internal class Grip
	{
		...
		internal Grip(int value, int width, int height, Sides side, Func<int> getCenterValue, Func<int> getMinValue , Func<int> getMaxValue)
		{
			Side = side;
		...
		private readonly Func<int> _getCenterValue;
		private readonly Func<int> _getMinValue;
		private readonly Func<int> _getMaxValue;
		private int _value;
