...
//
// Undo is NOT here: it belongs to the workspace, so helpers/workspace.ts has it. `clickUndoButton`
// clicks the top bar's Undo button, `pressUndoKey` presses Ctrl+Z, and `undo` is the setup route.
