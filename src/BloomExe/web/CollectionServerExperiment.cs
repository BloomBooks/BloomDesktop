...
namespace Bloom.web
{
	...
	public class CollectionServerExperiment : BloomServer
	{
		...
		public CollectionServerExperiment(CollectionSettings collectionSettings, BookCollection booksInProjectLibrary,
