...
namespace Bloom.Api
{
	...
	public class BloomServer : ServerBase
	{
		...
		public CollectionSettings CurrentCollectionSettings
		{
			get { return ApiHandler.CurrentCollectionSettings; }
			set { ApiHandler.CurrentCollectionSettings = value; }
		}
		...
		/// </summary>
		internal BloomServer(BookSelection bookSelection) : this( new RuntimeImageProcessor(new BookRenamedEvent()), bookSelection)
		{ }

		public BloomServer(RuntimeImageProcessor cache, BookSelection bookSelection,  BloomFileLocator fileLocator = null)
		{
