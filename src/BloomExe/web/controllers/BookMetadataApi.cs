			...
			switch (request.HttpMethod)
			{
				case HttpMethods.Get:
					...
					var translatedStringPairs = new
					{
						...
						a11yLevelNone = LocalizationManager.GetString("BookMetadata.A11yLevelNone", "None"),
						a11yLevelA = LocalizationManager.GetString("BookMetadata.A11yLevelA", "Level A conformance"),
						a11yLevelAA = LocalizationManager.GetString("BookMetadata.A11yLevelAA", "Level AA conformance"),
						a11yLevelAAA = LocalizationManager.GetString("BookMetadata.A11yLevelAAA", "Level AAA conformance"),
					};
					var blob = new
					{
						metadata,
