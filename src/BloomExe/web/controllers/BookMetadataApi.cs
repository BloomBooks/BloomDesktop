			...
			switch (request.HttpMethod)
			{
				case HttpMethods.Get:
					...
					var metadata = new
					{
						...
						name = new { type = "readOnlyText", value = _bookSelection.CurrentSelection.NameBestForUserDisplay,
						...
						inLanguage =  new { type = "readOnlyText", value = _bookSelection.CurrentSelection.BookData.Language1.Tag,
