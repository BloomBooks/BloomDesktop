...
namespace Bloom.web.controllers
{
	...
	internal class ProblemReportApi : IDisposable
	{
		...
		{			
			...
			apiHandler.RegisterHelperEndpointHandler("problemReport/reportHeading",
				(ApiRequest request) =>
				{
					request.ReplyWithText(_reportInfo.Heading ?? "");
				}, false);
			// ProblemDialog.tsx uses this endpoint to get the screenshot image.
			apiHandler.RegisterHelperEndpointHandler("problemReport/screenshot",
				(ApiRequest request) =>
				{
			...
			apiHandler.RegisterHelperEndpointHandler("problemReport/bookName",
				(ApiRequest request) =>
				{
			...
			apiHandler.RegisterHelperEndpointHandler("problemReport/emailAddress",
				(ApiRequest request) =>
				{
			...
			apiHandler.RegisterHelperEndpointHandler("problemReport/diagnosticInfo",
				(ApiRequest request) =>
				{
			...
			apiHandler.RegisterHelperEndpointHandler("problemReport/submit",
				(ApiRequest request) =>
				{
