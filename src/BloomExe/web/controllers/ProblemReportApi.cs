            ...
            SafeInvoke.InvokeIfPossible(
                ...
                () =>
                {
                    ...
                    try
                    {
                        ...
                        {
                            // Depending on the timing, we can get a "Invoke or BeginInvoke cannot be called on a control until the window handle has been created."
                            // exception here. Ignore
                        }
