...
namespace Bloom.web.controllers
{
	internal class ProblemReportApi : IDisposable
	{
		...
		// (That's what will the ReportInfo class is here for)
		...
		const bool kSyncNotRequired = false;	// False value means that sync is not required.
