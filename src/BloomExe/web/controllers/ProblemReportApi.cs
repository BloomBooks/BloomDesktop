...
namespace Bloom.web.controllers
{
	...
	internal class ProblemReportApi : IDisposable
	{
		...
		private void GetAdditionalBloomEnvironmentInfo(StringBuilder bldr)
		{
			...
			{
				var language3 = book.GetLanguage(LanguageSlot.Language3);
