...
namespace Bloom.web.controllers
{
    public class ImageApi
    {
        ...
        private static IEnumerable<string> GetImageFilesToNotPasteCreditsFor()
        {
            ...
            // Add the stock images used in the game buttons.
            var gameButtonImages = new[]
            {
                "Check Answer Symbol.svg",
                "Page Nav.svg",
                "Show Answer Symbol.svg",
                "Try Again Symbol.svg"
            };
            imageFiles.AddRange(gameButtonImages);
            return imageFiles;
        }
