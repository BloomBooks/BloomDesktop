...
namespace Bloom.web.controllers
{
	...
	class LibraryPublishApi
	{
		...
		{			
			...
			dynamic collisionDialogInfo = new
			{
				shouldShow = Model.BookIsAlreadyOnServer
			};
			if (Model.BookIsAlreadyOnServer)
			{
				...
				dynamic dialogProps = Model.GetUploadCollisionDialogProps(GetLanguagesToUpload(), signLanguageFeatureSelected);
				collisionDialogInfo = new
				{
					shouldShow = Model.BookIsAlreadyOnServer,
					// I can't find any way to do this automatically; pretty frustrating...
					dialogProps.userEmail,
					dialogProps.newThumbUrl,
					dialogProps.newTitle,
					dialogProps.newLanguages,
					dialogProps.existingTitle,
					dialogProps.existingLanguages,
					dialogProps.existingCreatedDate,
					dialogProps.existingUpdatedDate,
					dialogProps.existingBookUrl,
					dialogProps.existingThumbUrl
				};
			}
