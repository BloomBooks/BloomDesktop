	...
	public class PublishApi
	{
		...
		public void RegisterWithApiHandler(BloomApiHandler apiHandler)
		{
			...
			apiHandler.RegisterBooleanEndpointHandler("publish/hasActivities",
				...
				null, true);
			apiHandler.RegisterBooleanEndpointHandler("publish/comicEnabled",
				request => Model.Book.HasOverlayPages,
				null, true);
			apiHandler.RegisterBooleanEndpointHandler("publish/comic",
			...
			apiHandler.RegisterBooleanEndpointHandler("publish/visuallyImpairedEnabled",
			...
			apiHandler.RegisterEndpointHandler("publish/backColor", request =>
			{
			...
			apiHandler.RegisterEndpointHandler("publish/thumbnail", request =>
			{
			...
			apiHandler.RegisterBooleanEndpointHandler("publish/motionBookMode",
				...
				, true);
			apiHandler.RegisterEndpointHandler("publish/includeLanguage", request =>
			{
