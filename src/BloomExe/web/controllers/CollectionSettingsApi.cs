...
namespace Bloom.web.controllers
{
	...
	public class CollectionSettingsApi
	{
		...
		public static string InvalidBranding { get; set; } // set to display message about needing a branding code.
		...
		{	
			...
			{
				var summaryFile = BloomFileLocator.GetOptionalBrandingFile(GetBrandingFromCode(SubscriptionCode), "summary.htm");
				if (summaryFile == null)
