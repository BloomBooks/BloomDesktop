...
namespace Bloom.web.controllers
{
	...
	/// </summary>
	public class BackgroundAudioApi
	{

		private readonly BookSelection _bookSelection;

		// Called by autofac, which creates the one instance and registers it with the server.
		public BackgroundAudioApi(BookSelection _bookSelection)
		{
		...
		{
			server.RegisterEndpointHandler("bgAudio/ui/chooseFile", HandleRequest, true);
		}
		...
		private string ShowSelectMusicFile()
		{
			...
			var soundFiles = LocalizationManager.GetString("EditTab.Toolbox.BackgroundAudio.FileDialogSoundFiles", "Sound files");
