...
namespace Bloom.web
{
	...
	public class WebSocketProgress: IWebSocketProgress
	{
		...
		private string GetL10nId(string idSuffix, bool usePrefix)
		{
			if (usePrefix)
		...
		public void Error(string idSuffix, string message, bool usePrefix=true)
		{
			ErrorWithoutLocalizing(LocalizationManager.GetDynamicString(appId: "Bloom", id: GetL10nId(idSuffix, usePrefix), englishText: message));
		}
		...
		public void Message(string idSuffix, string comment, string message, bool usePrefix=true)
		{
			MessageWithoutLocalizing(LocalizationManager.GetDynamicString(appId: "Bloom", id: GetL10nId(idSuffix, usePrefix), englishText: message, comment: comment));
		}
		public void Message(string idSuffix, string message, bool usePrefix = true)
		{
			MessageWithoutLocalizing(LocalizationManager.GetDynamicString(appId: "Bloom", id: GetL10nId(idSuffix, usePrefix), englishText: message));
		}
		...
		public void MessageUsingTitle(string idSuffix, string message, string bookTitle, bool usePrefix = true)
		{
			var formatted = GetTitleMessage(idSuffix, message, bookTitle, usePrefix);
			MessageWithoutLocalizing(formatted);
		}

		public string GetTitleMessage(string idSuffix, string message, string bookTitle, bool usePrefix = true)
		{
			Debug.Assert(message.Contains("{0}"));
			Debug.Assert(!message.Contains("{1}"));
			var localized = LocalizationManager.GetDynamicString(appId: "Bloom", id: GetL10nId(idSuffix, usePrefix), englishText: message,
	...
	public interface IWebSocketProgress
	{
		...
		void Message(string idSuffix, string comment, string message, bool usePrefix = true);
	...
	public class NullWebSocketProgress : IWebSocketProgress
	{
		...
		public void Message(string id, string comment, string message, bool usePrefix = true)
		{
		}
