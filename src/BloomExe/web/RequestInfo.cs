...
namespace Bloom.Api
{
	...
	public class RequestInfo : IRequestInfo
	{
		...
		public void ReplyWithFileContent(string path, string originalPath = "")
		{
		...
		private bool ShouldCache(string path, string originalPath)
		{
			...
			if (path.StartsWith(DoNotCacheFolder) || originalPath.StartsWith(DoNotCacheFolder))
		...
		public void ReplyWithImage(string path, string originalPath = "")
		{
