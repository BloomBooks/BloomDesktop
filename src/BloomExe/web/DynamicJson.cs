...
namespace Bloom.Api
{
    public class DynamicJson : DynamicObject
    {
        ...
        private static IEnumerable<XStreamingElement> CreateXArray<T>(T obj)
            where T : IEnumerable
        {
        ...
        public override string ToString()
        {
            ...
            return CreateJsonString(
                new XStreamingElement("root", CreateTypeAttr(jsonType), xml.Elements())
            );
        }
        ...
        public bool IsEmpty
        {
            get
            {
                foreach (KeyValuePair<string, object> item in (dynamic)this)
                {
                    return false;
                }
                return true;
