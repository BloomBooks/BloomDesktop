		...
		public void HandleI18nRequest(ApiRequest request)
		{
			...
			switch (lastSegment)
			{
				...
				case "translate":
					...
					langId = langId.Replace("V", request.CurrentBook.BookData.GetLanguage(Book.LanguageSlot.Language1).Iso639Code);
					langId = langId.Replace("N1", request.CurrentBook.BookData.GetLanguage(Book.LanguageSlot.Language2).Iso639Code);
					langId = langId.Replace("N2", request.CurrentBook.BookData.GetLanguage(Book.LanguageSlot.Language3).Iso639Code);
