...
namespace Bloom.web
{
    ...
    public static class BloomLibraryUrls
    {
        ...
        public static string GetBloomLibraryUrlPrefix(bool ignoreSandbox)
        {
            return UrlLookup.LookupUrl(
                UrlType.LibrarySite,
                null,
                BookUpload.UseSandbox && !ignoreSandbox
            );
        }
        ...
        {
            return GetBloomLibraryUrlPrefix(ignoreSandbox)
        ...
        )
        {
            ...
            return $"{GetBloomLibraryUrlPrefix(ignoreSandbox)}/:search:bookInstanceId{doubleEncodedColon}{bookInstanceId}";
        }
    }
