...
namespace Bloom.Collection
{
    ...
    public class CollectionSettings
    {
        ...
        public string GetLanguageName(string tag, string inLanguage)
        {
            ...
            {
                // It is pretty important that we don't let this throw.
                // We look up language names while building the page dom, so it can result in the Edit tab being unusable.
                // See BL-15159.
                return tag;
            }
        }
