...
namespace Bloom.Collection
{
	...
	public class CollectionSettings
	{
		...
		{
			var name = _lookupIsoCode.GetLocalizedLanguageName(code, inLanguage);
			// This behavior is wanted in GetLanguage1Name_NoCache(), but not here apparently.
			//if (name == code)
			//{
			//	string exactLanguageMatch;
			//	if (!_lookupIsoCode.GetBestLanguageName(code, out exactLanguageMatch))
			//		return "L1-Unknown-" + code;
			//	return exactLanguageMatch;
			//}
			return name;
		}
