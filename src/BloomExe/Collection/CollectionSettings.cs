	...
	public class CollectionSettings
	{
		...
		public static readonly Dictionary<string, string> CssNumberStylesToCultureOrDigits =
			new Dictionary<string, string>()
			{
				...
				{ "Armenian", ""}, // from hy-AM yields 0123456789; not true Armenian, an ancient letter-value system
				{ "Upper-Armenian", ""}, // from hy-AM, probably a variation on Armenian also not permitting digit-substitution
				...
				{ "Georgian", ""}, //  ka-GE yields 0123456789; https://en.wikipedia.org/wiki/Georgian_numerals says Georgian is not a simple positional system
				{ "Gujarati", "૦૧૨૩૪૫૬૭૮૯"}, // from gu-IN
				{ "Gurmukhi", "੦੧੨੩੪੫੬੭੮੯"}, // from pa-IN
				{ "Hebrew", ""}, // he-IL yields 0123456789; not true Hebrew, which uses a non-positional letter-value system.
