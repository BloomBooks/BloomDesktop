...
namespace Bloom.Collection
{
	public partial class CollectionSettingsDialog : SIL.Windows.Forms.Miscellaneous.FormForUsingPortableClipboard
	{
		...
		public CollectionSettingsDialog(CollectionSettings collectionSettings, XMatterPackFinder xmatterPackFinder, QueueRenameOfCollection queueRenameOfCollection, PageRefreshEvent pageRefreshEvent, TeamCollectionManager tcManager)
		{
			...
			_showExperimentalBookSources.Checked = Settings.Default.EnabledExperimentalFeatures.Contains(Program.AllowExperimentalSources);
			_allowTeamCollection.Checked = Settings.Default.EnabledExperimentalFeatures.Contains(Program.AllowTeamCollection);
			if (!Settings.Default.EnabledExperimentalFeatures.Contains(Program.AllowTeamCollection) && tcManager.CurrentCollectionEvenIfDisconnected == null)
			{
...
//		                                              };
		...
		{
			Settings.Default.EnabledExperimentalFeatures.Remove(Program.AllowExperimentalSources);
			if (_showExperimentalBookSources.Checked)
				Settings.Default.EnabledExperimentalFeatures.Add(Program.AllowExperimentalSources);
			ChangeThatRequiresRestart();
		}
		...
		{
			Settings.Default.EnabledExperimentalFeatures.Remove(Program.AllowTeamCollection);
			if (_allowTeamCollection.Checked)
				Settings.Default.EnabledExperimentalFeatures.Add(Program.AllowTeamCollection);
			ChangeThatRequiresRestart();
		}
	}
}
