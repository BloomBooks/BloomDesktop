	...
	public class SpreadsheetExporter
	{
		...
		public InternalSpreadsheet Export(HtmlDom dom, string imagesFolderPath)
		{
			...
			foreach (var page in pages)
			{
				...
				{
					rowsForPage.AddRange(AddImageRow(imageContainer, pageNumber, imagesFolderPath));
				}
				...
				{
					rowsForPage.Add(AddTranslationGroupRow(group, pageNumber));
				}
		...
		private List<SpreadsheetRow> AddImageRow(XmlElement imageContainer, string pageNumber, string imagesFolderPath)
		{
		...
		private SpreadsheetRow AddTranslationGroupRow(XmlNode group, string pageNumber)
		{
			var row = new ContentRow(_spreadsheet);
