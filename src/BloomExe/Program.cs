...
namespace Bloom
{
    ...
    static class Program
    {
        ...
        // The folder where we tell Velopack to look for upgrades.
        ...
        // (These names are obsolete now Squirrel has been replaced by Velopack, but we want older Blooms
        // to find them so they can automatically upgrade to Velopack.)
