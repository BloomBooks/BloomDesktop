...
namespace Bloom
{
    public static class XmlHtmlConverter
    {
        ...
        public static string CreateValidHtmlString(string bodyContent, string headContent = null)
        {
            return $@"<html>
  <head>
  {headContent ?? @"
  ...
  <body>
    {bodyContent}
        ...
        )
        {
            ...
            // Remove comments (e.g. <!-- foobar -->), doctype declaration (<!DOCTYPE html>), and whitespace at the top of the file.
        ...
        public static string ConvertElementToHtml5(SafeXmlElement elt)
        {
            ...
            var docHtml = ConvertXhtmlToHtml5(CreateValidHtmlString(xmlStringBuilder.ToString()));
