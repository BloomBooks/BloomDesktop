...
namespace Bloom.ToPalaso
{
	...
	public static class XmlExtensions
	{
		...
		/// <summary>
		/// Find the closest parent (not 'start' itself) that has the specified value for the specified attribute.
		/// If no parent does, answer null.
		/// </summary>
		/// <returns></returns>
		public static XmlElement ParentWithAttributeValue(this XmlElement start, string targetAttr, string targetVal)
		{
			var current = start.ParentNode as XmlElement;
