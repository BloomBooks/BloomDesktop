...
namespace Bloom.ToPalaso
{
    ...
    public static class CommandLineRunnerExtra
    {
        ...
        public static ExecutionResult RunWithInvariantCulture(
            string exePath,
            string arguments,
        ...
        {
            return RunWithInvariantCulture(
                exePath,
                arguments,
                null,
                fromDirectory,
        ...
        public static ExecutionResult RunWithInvariantCulture(
            ...
            int secondsBeforeTimeOut,
            IProgress progress,
            Action<string> actionForReportingProgress = null,
    ...
    {
        public static ExecutionResult StartWithInvariantCulture(
            ...
            int secondsBeforeTimeOut,
            IProgress progress,
            Action<string> actionForReportingProgress,
            string standardInputPath = null,
            bool isManagedProcess = false
        )
        {
