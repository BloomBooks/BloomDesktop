...
namespace Bloom
{
    ...
    internal class ProgressUpdateReporter : UpdateReporter
    {
        ...
        /// because a toast is all the user gets; here the caller acts on the Downloaded outcome
        /// itself -- the dialog closes and Bloom restarts -- so announcing it first would be news
        /// about something the user is about to watch happen.
        /// </summary>
        public override void OfferToRestart(string message, string acceptLabel, Action accept) { }
