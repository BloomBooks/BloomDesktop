namespace Bloom.WebLibraryIntegration
{
	partial class OverwriteWarningDialog
	{
		...
		private void InitializeComponent()
		{
			...
			this._L10NSharpExtender.SetLocalizingId(this.label1, "OverwriteWarning.AlreadyUploaded");
			this.label1.Location = new System.Drawing.Point(29, 34);
			this.label1.Name = "label1";
			this.label1.Size = new System.Drawing.Size(243, 70);
			this.label1.TabIndex = 0;
			this.label1.Text = "You have already uploaded this book; do you want to replace the previous version?" +
    "";
			// 
			...
			this._replaceExistingButton.Location = new System.Drawing.Point(32, 107);
			...
			this._cancelButton.Location = new System.Drawing.Point(32, 157);
