	...
	public class BookUpload
	{
		...
		internal string FullUpload(Book.Book book, IProgress progress, PublishModel publishModel, BookUploadParameters bookParams, out string parseId)
		{
			...
			try
			{
				...
				var thumbnailsExist = PatientFile.Exists(Path.Combine(bookFolder, "thumbnail-70.png")) &&
				                      PatientFile.Exists(Path.Combine(bookFolder, "thumbnail-256.png")) &&
				                      PatientFile.Exists(Path.Combine(bookFolder, "thumbnail.png"));
