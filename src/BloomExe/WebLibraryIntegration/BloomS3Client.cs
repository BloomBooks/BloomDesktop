...
namespace Bloom.WebLibraryIntegration
{
	...
	public class BloomS3Client:IDisposable
	{
		...
		public void UploadBook(string storageKeyOfBookFolder, string pathToBloomBookDirectory, IProgress progress,
			string pdfToInclude = null, ISet<string> audioFilesToInclude = null, IEnumerable<string> videoFilesToInclude = null, string[] languagesToInclude = null, IEnumerable<string> collectionLanguages=null)
		{
			BaseUrl = null;
			...
			if (languagesToInclude != null && languagesToInclude.Count() > 0)
				RemoveUnwantedLanguageData(destDirName, languagesToInclude, collectionLanguages);
		...
		public void RemoveUnwantedLanguageData(string destDirName, IEnumerable<string> languagesToInclude, IEnumerable<string> collectionLanguages)
		{
			...
			foreach (var filepath in Directory.EnumerateFiles(destDirName, "*.htm"))
			{
				...
				PublishModel.RemoveUnwantedLanguageData(dom, languagesToInclude, collectionLanguages);
