...
namespace Bloom
{
    ...
    public class BloomFileLocator : IChangeableFileLocator
    {
        ...
        public static IDisposable OverrideForScope(BloomFileLocator previousLocatorToRestore)
        {
            if (previousLocatorToRestore == null)
                throw new ArgumentNullException(nameof(previousLocatorToRestore));

            return new LocatorOverride(previousLocatorToRestore);
        }
