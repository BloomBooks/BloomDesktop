...
//autofac uses this
			...
			)
		{
			...
			ErrorReport.OnShowDetails = ProblemReportApi.ShowProblemDialog;
			InitializeComponent();
		...
		private void StartProblemReport(object sender, EventArgs e)
		{
			...
			// To test clicking 'Report' in a toast, uncomment this line.
			//NonFatalProblem.Report(ModalIf.None, PassiveIf.All, "My test 'yellow screen' error", "Any more details here?");
