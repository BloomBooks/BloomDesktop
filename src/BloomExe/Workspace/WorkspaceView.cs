...
//			}
		...
		private void SetupUiLanguageMenu()
		{
			...
			_showAllTranslationsItem.Text = LocalizationManager.GetString("CollectionTab.LanguageMenu.ShowUnapprovedTranslations", "Show translations which have not been approved yet");
