...
namespace Bloom.MiscUI
{
	...
	public static class DefenderFolderProtectionCheck
	{
		...
		private static void ReportDefenderProblem(Exception exc, string failingFolder)
		{
			...
			var caption = LocalizationManager.GetString("BloomIntegrity.WindowTitle", "Bloom Problem");
			MessageBox.Show(msg, caption, System.Windows.MessageBoxButton.OK, MessageBoxImage.Exclamation);
			Process.Start("https://docs.bloomlibrary.org/windows-controlled-folder-access");
		}
