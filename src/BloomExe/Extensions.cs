    ...
    public static class Extensions
    {
        ...
        public static string ToLocalhost(this string fileName)
        {
            ...
            return BloomServer.ServerUrlWithBloomPrefixEndingInSlash
                + fileName.EscapeFileNameForHttp();
        }
        ...
        public static string EscapeFileNameForHttp(this string fileName)
        {
            ...
            try
            {
                var escapedPathComponents = fileName
                    .Split(kDirectorySeparators)
        ...
        /// </summary>
        public static IEnumerable<T> MapUnevenPairs<T1, T2, T>(
        ...
        public static void SaveImageRobustly(
            this SIL.Windows.Forms.ImageToolbox.PalasoImage image,
            string fileName,
            HashSet<Type> exceptionTypesToRetry,
