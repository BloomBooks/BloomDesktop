...
namespace Bloom.ErrorReporter
{
	...
	public class ErrorReportUtils
	{
		...
		private static void CheckForFakeTestErrors(string title)
		{
			...
			{
				// Tests another path through libPalaso directly (goes thru overloads 3, 4)
			...
			{
				// Tests the legacy 5-argument implementation in libpalaso
