...
namespace Bloom.ErrorReporter
{
	...
	public class HtmlErrorReporter: IErrorReporter, IBloomErrorReporter
	{
		...
		/// </summary>
		/// <param name="reportButtonLabel">The localized text for the report button. Pass null for default behavior. Pass "" to disable.</param>
		...
		/// Pass null for default behavior (disabled). Pass "" to disable.</param>
		/// <param name="onExtraButtonPressed">The action to execute after the secondary action button is pressed. Pass null to use the default behavior (disabled)</param>
