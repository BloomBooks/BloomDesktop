...
namespace Bloom
{
	public partial class Browser : UserControl
	{
		...
		public static void SetUpXulRunner()
		{
			...
			// Some more settings look like they may be useful to reduce memory consumption.
			...
			GeckoPreferences.User["image.mem.min_discard_timeout_ms"] = 500;		// (default = 10000)
			GeckoPreferences.User["image.mem.surfacecache.max_size_kb"] = 40960;	// 40MB (default = 102400 == 100MB)
			GeckoPreferences.User["image.mem.surfacecache.min_expiration_ms"] = 500;	// (default = 60000)
