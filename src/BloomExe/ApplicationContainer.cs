...
namespace Bloom
{
		...
		public class ApplicationContainer : IDisposable
		{
			...
			public ApplicationContainer()
			{
				...
				var socketServer = new BloomWebSocketServer();
				WebSocketServer = socketServer;

				// Makes this one object the thing to return for the interface as well as the class.
				builder.RegisterInstance(socketServer).As<BloomWebSocketServer>().As<IBloomWebSocketServer>().SingleInstance();
				...
				builder.Register(c => NavigationIsolator.GetOrCreateTheOneNavigationIsolator())
					.InstancePerLifetimeScope();

				builder.Register<HtmlThumbNailer>(c => new HtmlThumbNailer(c.Resolve<NavigationIsolator>()))
					.SingleInstance();
				builder.Register<BookThumbNailer>(c => new BookThumbNailer(c.Resolve<HtmlThumbNailer>()))
					.SingleInstance();
			...
			public static IBloomWebSocketServer WebSocketServer;
