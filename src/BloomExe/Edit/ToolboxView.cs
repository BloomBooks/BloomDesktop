...
namespace Bloom.Edit
{
	...
	{
		static readonly string[] IdsOfToolsThisVersionKnowsAbout = new[] { DecodableReaderTool.StaticToolId, LeveledReaderTool.StaticToolId, TalkingBookTool.StaticToolId, BookSettingsTool.StaticToolId, PanAndZoomTool.StaticToolId, BackgroundAudioTool.StaticToolId };
		...
		public static IEnumerable<string> GetToolboxServerDirectories()
		{
			...
			yield return BloomFileLocator.GetBrowserDirectory("bookEdit/toolbox/backgroundAudio");
