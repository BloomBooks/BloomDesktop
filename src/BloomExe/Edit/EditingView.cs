...
//			//focus() made it worse, select has no effect
	...
	// Check memory for the benefit of developers.
				...
				// here is to set a flag that page selection is still processing, and blocking any
				// further page selecting until the current one has finished loading the page.
