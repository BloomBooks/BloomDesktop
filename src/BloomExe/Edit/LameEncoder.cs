...
namespace Bloom.Edit
{
	...
	public class LameEncoder
	{
		...
		public void Encode(string sourcePath, string destPathWithoutExtension, IProgress progress)
		{
			...
			{
				var shortMsg = LocalizationManager.GetString("LameEncoder.DeleteFailedShort", "Cannot replace mp3 file");
				...
				NonFatalProblem.Report(ModalIf.None, PassiveIf.All, shortMsg, longMsg, ex, false);
				return;
			}
