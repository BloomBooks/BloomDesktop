	...
	public class BloomMetadataEditorDialog : MetadataEditorDialog
	{
		...
		public BloomMetadataEditorDialog(Metadata metadata, bool isDerivedBook) : base(metadata)
		{
			...
			if (isDerivedBook)
			{
				...
				var metaLocation = MetadataControl.Location;
				var metaSize = MetadataControl.Size;
				MetadataControl.Dock = DockStyle.None;
				...
				MetadataControl.Location = new System.Drawing.Point(metaLocation.X, metaLocation.Y + topPanel.Height);
				MetadataControl.Size = metaSize;
