namespace Bloom.Edit
{
    partial class PageListView
    {
        ...
        private void InitializeComponent()
        {
			...
			this._pageControlsView = new Bloom.Edit.PageControlsView();
			...
			// _pageControlsView
			//
			this._pageControlsView.BackColor = System.Drawing.SystemColors.Control;
			this._pageControlsView.Dock = System.Windows.Forms.DockStyle.Bottom;
			this._pageControlsView.ForeColor = System.Drawing.SystemColors.WindowText;
			this._L10NSharpExtender.SetLocalizableToolTip(this._pageControlsView, null);
			this._L10NSharpExtender.SetLocalizationComment(this._pageControlsView, null);
			this._L10NSharpExtender.SetLocalizingId(this._pageControlsView, "PageControlsView");
			this._pageControlsView.Name = "_pageControlsView";
			this._pageControlsView.Size = new System.Drawing.Size(136, 150);
			this._pageControlsView.TabIndex = 5;
			//
			// PageListView
			//
			...
			this.Controls.Add(this._pageControlsView);
		...
		private PageControlsView _pageControlsView;
	}
}
