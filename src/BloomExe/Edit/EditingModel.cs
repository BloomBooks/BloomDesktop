	...
	public class EditingModel
	{
		...
		public IEnumerable<ContentLanguage> ContentLanguages
		{
			get
			{
				...
				{
					_contentLanguages.Add(new ContentLanguage(_bookSelection.CurrentSelection.GetLanguage(LanguageSlot.Language1)) { Locked = true, Selected = true });
					...
					var item2 = new ContentLanguage(_bookSelection.CurrentSelection.GetLanguage(LanguageSlot.Language2));
					_contentLanguages.Add(item2);
					if (!String.IsNullOrEmpty(_bookSelection.CurrentSelection.GetLanguage(LanguageSlot.Language3).Iso639Code))
					{
						var item3 = new ContentLanguage(_bookSelection.CurrentSelection.GetLanguage(LanguageSlot.Language3));
						_contentLanguages.Add(item3);
					}
				}
				//update the selections
				var lang2 = _contentLanguages.FirstOrDefault(l => l.Iso639Code == _bookSelection.CurrentSelection.GetLanguage(LanguageSlot.Language2).Iso639Code);
				if (lang2 != null)
					lang2.Selected = CurrentBook.MultilingualContentLanguage2 == _bookSelection.CurrentSelection.GetLanguage(LanguageSlot.Language2).Iso639Code;
				else
				...
				var lang1 = _contentLanguages.FirstOrDefault(l => l.Iso639Code == _bookSelection.CurrentSelection.GetLanguage(LanguageSlot.Language1).Iso639Code);
				if (lang1 != null)
					lang1.Selected = true;
				else
				...
				var contentLanguageMatchingNatLan2 =
					_contentLanguages.Where(l => l.Iso639Code == _bookSelection.CurrentSelection.GetLanguage(LanguageSlot.Language3).Iso639Code).FirstOrDefault();

				if(contentLanguageMatchingNatLan2!=null)
				{
					contentLanguageMatchingNatLan2.Selected =
					CurrentBook.MultilingualContentLanguage2 ==_bookSelection.CurrentSelection.GetLanguage(LanguageSlot.Language3).Iso639Code
					|| CurrentBook.MultilingualContentLanguage3 == _bookSelection.CurrentSelection.GetLanguage(LanguageSlot.Language3).Iso639Code;
				}
...
//		}
		...
		public string GetFontAvailabilityMessage()
		{
			...
			var name = _bookSelection.CurrentSelection.GetLanguage(LanguageSlot.Language1).FontName.ToLowerInvariant();
			...
			if (null == FontFamily.Families.FirstOrDefault(f => f.Name.ToLowerInvariant() == name))
			{
				...
				return String.Format(s, _bookSelection.CurrentSelection.GetLanguage(LanguageSlot.Language1).FontName);
			}
			return null;
		}
