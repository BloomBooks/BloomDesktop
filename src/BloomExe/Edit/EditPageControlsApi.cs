...
{
	/// <summary>
	/// Handles api request dealing with the page manipulation controls at the bottom of the pageThumbnailList
	/// (left side of Edit tab screen).
	/// </summary>
	public class EditPageControlsApi
	{
		...
		public EditPageControlsApi(EditingModel model)
		{
			_editingModel = model;
			_webSocketServer = _editingModel.EditModelSocketServer;
			_editingModel.PageSelectedChangedEvent += PageSelectedChangedEventHandler;
		}

		private void PageSelectedChangedEventHandler(object sender, EventArgs e)
		{
