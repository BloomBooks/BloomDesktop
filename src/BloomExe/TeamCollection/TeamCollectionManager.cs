...
namespace Bloom.TeamCollection
{
	...
	public class TeamCollectionManager: IDisposable, ITeamCollectionManager
	{
		...
		// We'd prefer to have Autofac just pass us the collection settings, as most
		// classes that need one do. But TCM must be created by AutoFac before
		// CollectionSettings, so it can sync the latest version of the CS file
		// before the CS is loaded. So we need another way to get it when needed
		// later. This is the least kludgy I've found.
		private CollectionSettings Settings => TeamCollectionApi.TheOneInstance.Settings;
