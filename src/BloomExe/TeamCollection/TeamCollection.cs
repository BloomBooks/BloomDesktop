...
namespace Bloom.TeamCollection
{
	...
	public abstract class TeamCollection: IDisposable
	{
		...
		/// get the name of the corresponding local team collection. Currently this involves
		/// removing the trailing " - TC" if present. This involves more knowledge of
		/// the FolderTeamCollection implementation than I would like in a TeamCollection
		/// method. If we ever get another implementation, thought will be needed as to
		/// how to get a local collection name from the .JoinBloomTC file path. At least,
		/// callers of this will indicate where we need to adjust things.
		/// </summary>
