...
namespace Bloom.TeamCollection
{
    ...
    public abstract partial class TeamCollection : IDisposable, ISaveContext
    {
        ...
        internal void UpdateAllowCheckoutsFromRepo()
        {
            ...
            // The caller (HandleRemoteBookChangesOnIdle) tells the browser to re-read book status
            // immediately after this, which is what makes the checkout button and its explanation
