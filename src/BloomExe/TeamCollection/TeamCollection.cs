...
namespace Bloom.TeamCollection
{
	...
	public abstract class TeamCollection: IDisposable
	{
		...
		/// 'delete's a file as part of the process of writing a new version of it.
		...
		internal void HandleRemoteBookChangesOnIdle(object sender, EventArgs e)
		{
			if(_pendingRepoChanges.TryDequeue(out RepoChangeEventArgs args))
			{
				...
				if (args is NewBookEventArgs newArgs)
					...
					HandleDeletedFileDelayed(delArgs);
		...
		private void HandleDeletedFileDelayed(DeleteRepoBookFileEventArgs delArgs)
		{
