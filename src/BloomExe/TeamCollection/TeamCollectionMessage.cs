...
namespace Bloom.TeamCollection
{
    ...
    public class TeamCollectionMessage
    {
        ...
        public TeamCollectionMessage(
            ...
            string l10nId,
            string rawEnglishMessageTemplate,
            string param0 = null,
            string param1 = null
        )
        {
            ...
            get
            {
                ...
                if (String.IsNullOrEmpty(RawEnglishMessageTemplate))
                {
                    switch (MessageType)
                    {
                        ...
                        case MessageAndMilestoneType.Reloaded:
                            return null;
                ...
                var msg = string.IsNullOrEmpty(L10NId)
                    ? RawEnglishMessageTemplate
                    : LocalizationManager.GetString(L10NId, RawEnglishMessageTemplate);
