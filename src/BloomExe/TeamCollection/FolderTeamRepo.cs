...
namespace Bloom.TeamCollection
{
	...
	public class FolderTeamRepo: TeamRepo
	{
		...
		{
			var sharedSettingsPath = Path.Combine(localCollectionFolder, "TeamSettings.xml");
		...
		public void ConnectToTeamCollection(string sharedFolder)
		{
			...
			CreateTeamSettingsFile(_localCollectionFolder, sharedFolder);
		...
		public static string JoinCollectionTeam(string path)
		{
			...
			CreateTeamSettingsFile(localSharedFolder, sharedFolder);
		...
		public static void CreateTeamSettingsFile(string collectionFolder, string teamCollectionFolder) {
