...
namespace Bloom.TeamCollection
{
	...
	public class TeamCollectionApi
	{
		...
		public void RegisterWithApiHandler(BloomApiHandler apiHandler)
		{
			...
			apiHandler.RegisterEndpointHandlerUsedByOthers("teamCollection/showCreateDialog", HandleShowCreateDialog, true);
		}

		private void HandleShowCreateDialog(ApiRequest request)
		{
			var url = BloomFileLocator.GetBrowserFile(false, "teamCollection", "CreateTeamCollection.html").ToLocalhost();
		...
		public void HandleChooseFolderLocation(ApiRequest request)
		{
			...
			using (var dlg = new FolderBrowserDialog())
			{
				...
				messageBundle.sharedFolderPath = _folderForCreateTC;
