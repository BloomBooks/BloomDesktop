	...
	public class FolderTeamCollection: TeamCollection
	{
		...
		protected override DateTime LastRepoCollectionFileModifyTime
		{
			get
			{
				...
				CombineModifyTimes("Allowed Words", ref collectionFilesModTime);
				CombineModifyTimes("Sample Texts", ref collectionFilesModTime);
				return collectionFilesModTime;
			}
		}

		private void CombineModifyTimes(string folderName, ref DateTime max)
		{
