...
namespace Bloom.Publish
{
	public partial class PublishView : UserControl, IBloomTabArea 
	{
		...
		public PublishView(PublishModel model, 
			SelectedTabChangedEvent selectedTabChangedEvent, BookUpload bookTransferrer, 
			PublishEpubApi publishEpubApi, PublishAudioVideoAPI publishToVideoApi, BloomWebSocketServer webSocketServer)
		{
			...
			_L10NSharpExtender = new L10NSharp.UI.L10NSharpExtender(components);
			((System.ComponentModel.ISupportInitialize)(_L10NSharpExtender)).BeginInit();
			_L10NSharpExtender.SetLocalizableToolTip(_reactControl, null);
			_L10NSharpExtender.SetLocalizationComment(_reactControl, null);
			_L10NSharpExtender.SetLocalizingId(_reactControl, "ReactControl");
			_L10NSharpExtender.SetLocalizableToolTip(this, null);
			_L10NSharpExtender.SetLocalizationComment(this, null);
			_L10NSharpExtender.SetLocalizingId(this, "PublishTab");
			((System.ComponentModel.ISupportInitialize)(_L10NSharpExtender)).EndInit();
