...
namespace Bloom.Publish.Android
{
	...
	public static class BloomPubMaker
	{
			...
			AndroidPublishSettings settings = null)
		{
			...
			BookCompressor.CompressBookDirectory(outputPath, modifiedBook.FolderPath, "", imagePublishSettings: settings?.ImagePublishSettings ?? ImagePublishSettings.Default,
