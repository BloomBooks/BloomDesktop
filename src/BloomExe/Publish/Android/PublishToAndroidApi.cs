...
namespace Bloom.Publish.Android
{
	...
	public class PublishToAndroidApi
	{
		...
		{
			Analytics.Track("Publish Android", new Dictionary<string, string>() {{"mode", mode}, {"BookId", book.ID}, { "Country", book.CollectionSettings.Country}, {"Language", book.GetLanguage(LanguageSlot.Language1).Iso639Code}});
		}
