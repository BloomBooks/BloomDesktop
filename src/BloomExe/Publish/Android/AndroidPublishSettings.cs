	...
	public class AndroidPublishSettings
	{
		...
		public static AndroidPublishSettings FromBookInfo(BookInfo bookInfo)
		{
			...
			return new AndroidPublishSettings()
			{
				...
				ImagePublishSettings = bookInfo.PublishSettings.BloomPub.Images != null ? new ImagePublishSettings(bookInfo.PublishSettings.BloomPub.Images) : ImagePublishSettings.Default
			};
		}
