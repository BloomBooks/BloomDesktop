	...
	public class WiFiPublisher
	{
		...
		public void Start(Book.Book book, CollectionSettings collectionSettings, Color backColor)
		{
			...
			_progress.Message(idSuffix: "WifiInstructions1",
				comment: "On the Android, run Bloom Reader, open the menu and choose 'Receive Books from computer'.");
			_progress.Message(idSuffix: "WifiInstructions2",
				comment: "You can do this on as many devices as you like. Make sure each device is connected to the same network as this computer.");
		}
