...
namespace Bloom.Publish.Video
{
	...
	public partial class RecordVideoWindow : Form
	{
		...
		public void Show(string bookUrl, string pathToRealBook)
		{
			...
			// TODO: It'd be great if you updated the preview instance of bloom-player too???
			...
			switch (format)
			{
				...
				case "facebook":
					...
					else // Portrait
					{
						...
						// (FYI, even if the video has acommpanying text in the post, the video is still allotted up to the 2:3 area.)
						//
						// Note: this is for user-uploaded videos, not ads.
						//    My guess is that ours users will be primarily doing these as uploads, not as ad videos. But that's just a guess.
						...
						//    * We could specifically add 4:5 page layout for them, and fix this if condition to handle layouts other than "A5 Portrait" properlty
