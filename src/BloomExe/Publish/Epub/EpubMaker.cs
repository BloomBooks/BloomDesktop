...
namespace Bloom.Publish.Epub
{
	...
	public class EpubMaker : IDisposable
	{
		...
		public void StageEpub(IWebSocketProgress progress, bool publishWithoutAudio = false)
		{
			...
			progress.Message("PublishTab.Epub.BuildingEPub","Shown in a progress box when Bloom is starting to creat an epub","Building Epub");
		...
		{
			progress.Message("Saving", "Shown in a progress box when Bloom is saving an epub", "Saving");
