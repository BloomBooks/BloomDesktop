...
namespace Bloom.Publish.Epub
{
	...
	public class EpubMaker : IDisposable
	{
		...
		public void StageEpub(WebSocketProgress progress, bool publishWithoutAudio = false)
		{
			...
			// Note that the BringBookUpToDate called by PublishHelper.MakeDeviceXmatterTempBook applies to a
			// copy of the book and is done in a way that explicitly avoids updating images.
