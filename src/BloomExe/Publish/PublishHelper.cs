...
namespace Bloom.Publish
{
	public class PublishHelper : IDisposable
	{
		...
		//		retval =  FileLocationUtilities.GetFileDistributedWithApplication(false,
		//			file.Substring(BloomServer.ServerUrlWithBloomPrefixEndingInSlash.Length));
		//	Console.WriteLine("DEBUG: GetRealFontFilePath(\"{0}\") => \"{1}\" [\"{2}\"]", file, retval, BloomServer.ServerUrlWithBloomPrefixEndingInSlash);
		//	return retval;
		//}
