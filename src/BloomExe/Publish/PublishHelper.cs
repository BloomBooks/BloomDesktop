...
namespace Bloom.Publish
{
	public class PublishHelper : IDisposable
	{
		...
		{
			if (!Program.RunningUnitTests && !Program.RunningInConsoleMode && WorkspaceView._tabSelection.ActiveTab != WorkspaceTab.publish  && !Program.RunningUnitTests && !Program.RunningInConsoleMode)
			{
