...
namespace Bloom.Publish
{
	public class PublishHelper : IDisposable
	{
		...
		public void RemoveUnwantedContent(HtmlDom dom, Book.Book book, ISet<string> warningMessages, EpubMaker epubMaker = null)
		{
			...
			if (ControlForInvoke != null)
			{
				...
				{
					RemoveUnwantedContentInternal(dom, book, epubMaker, warningMessages);
				}));
			}
			else
				RemoveUnwantedContentInternal(dom, book, epubMaker, warningMessages);
		...
		private void RemoveUnwantedContentInternal(HtmlDom dom, Book.Book book, EpubMaker epubMaker, ISet<string> warningMessages)
		{
