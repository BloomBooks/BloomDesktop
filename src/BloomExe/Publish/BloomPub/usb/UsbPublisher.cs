    ...
    public class UsbPublisher
    {
        ...
        )
        {
            try
            {
                ...
                _connectionHandler.DoWork += (sender, args) =>
                    _androidDeviceUsbConnection.ConnectAndSendToOneDevice(
                        book,
                        backColor,
                        settings
                    );
        ...
        private void HandleOneReadyDeviceFound(
            Book.Book book,
            Color backColor,
            BloomPubPublishSettings settings = null
        )
        ...
        private void HandleOneReadyDeviceNotFound(
            DeviceNotFoundReportType reportType,
        ...
        )
        {
            try
            {
                ...
                {
                    SendBookDoWork(book, backColor, settings);
                };
        ...
        protected virtual void SendBookDoWork(
            Book.Book book,
            Color backColor,
            BloomPubPublishSettings settings = null
        )
        ...
        private void FailSendBook(Exception e)
        {
            ...
            else
            {
                ...
                if (e != null)
                {
                    ...
                    _progress.MessageWithoutLocalizing(
                        "\tTechnical details to share with the development team: ",
                        ProgressKind.Error
                    );
