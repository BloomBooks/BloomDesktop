    ...
    public class BloomPubPublishSettings
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return LanguagesToInclude.SetEquals(other.LanguagesToInclude)
                && DistributionTag == other.DistributionTag
        ...
        public override int GetHashCode()
        {
            return LanguagesToInclude.GetHashCode()
                + DistributionTag.GetHashCode()
                + (PublishAsMotionBookIfApplicable ? 1 : 0);
        ...
        private static HashSet<string> GetLanguagesToExclude(
            Dictionary<string, InclusionSetting> libraryDict
        )
        {
            return new HashSet<string>(
                libraryDict.Where(kvp => !kvp.Value.IsIncluded()).Select(kvp => kvp.Key)
            );
        }
        ...
        public static BloomPubPublishSettings FromBookInfo(BookInfo bookInfo)
        {
            ...
            return new BloomPubPublishSettings()
            {
                ...
                PublishAsMotionBookIfApplicable = bookInfo
                    .PublishSettings
                    .BloomPub
        ...
        public static BloomPubPublishSettings GetPublishSettingsForBook(
        ...
        )
        {
            ...
            if (
                bookInfo.PublishSettings.BloomLibrary.TextLangs.Count == 0
                || bookInfo.PublishSettings.BloomLibrary.AudioLangs.Count == 0
            )
            {
