...
//			System.Diagnostics.Process.Start(tempHtml.Path);
		...
		internal BookThumbNailer ThumbNailer => _thumbNailer;
		internal BookServer BookServer => _bookServer;
		internal CollectionSettings CollectionSettings => _collectionSettings;
