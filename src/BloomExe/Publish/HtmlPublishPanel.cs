...
namespace Bloom.Publish
{
	...
	public partial class HtmlPublishPanel : UserControl
	{
		...
		public HtmlPublishPanel(string pathToHtmlFile)
		{
			...
			_browser.OnBrowserClick += PreviewBrowserClick;
		...
		/// Note that Readium handles these clicks internally and we never get to see them.
		/// </remarks>
		private void PreviewBrowserClick(object sender, EventArgs e)
		{
