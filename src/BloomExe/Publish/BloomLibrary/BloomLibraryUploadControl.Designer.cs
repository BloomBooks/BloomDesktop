...
namespace Bloom.Publish.BloomLibrary
{
	partial class BloomLibraryUploadControl
	{
		...
		private void InitializeComponent()
		{
			...
			this._helpPanel = new System.Windows.Forms.Panel();
    ...
    "ed books on the Bloom Library.";
			...
			this._helpLabel.Dock = System.Windows.Forms.DockStyle.Left;
			this._helpLabel.Font = new System.Drawing.Font("Segoe UI", 10F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this._helpLabel.ForeColor = System.Drawing.SystemColors.ControlText;
			this._L10NSharpExtender.SetLocalizableToolTip(this._helpLabel, null);
			this._L10NSharpExtender.SetLocalizationComment(this._helpLabel, null);
			this._L10NSharpExtender.SetLocalizingId(this._helpLabel, "Common.Help");
			this._helpLabel.Location = new System.Drawing.Point(0, 0);
			this._helpLabel.Name = "_helpLabel";
			this._helpLabel.Size = new System.Drawing.Size(41, 19);
			this._helpLabel.TabIndex = 38;
			this._helpLabel.Text = "Help";
			// 
			// _helpLink
			// 
			this._helpLink.AutoSize = true;
			this._L10NSharpExtender.SetLocalizableToolTip(this._helpLink, null);
			this._L10NSharpExtender.SetLocalizationComment(this._helpLink, null);
			this._L10NSharpExtender.SetLocalizingId(this._helpLink, "PublishTab.ButtonThatShowsUploadForm");
			this._helpLink.Location = new System.Drawing.Point(0, 25);
			this._helpLink.Name = "_helpLink";
			this._helpLink.Size = new System.Drawing.Size(94, 13);
			this._helpLink.TabIndex = 39;
			this._helpLink.TabStop = true;
			this._helpLink.Text = "Share on the Web";
			this._helpLink.TextAlign = System.Drawing.ContentAlignment.TopRight;
			this._helpLink.LinkClicked += new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this._helpLink_LinkClicked);
			// 
			...
			this._narrationAudioCheckBox.CheckedChanged += new System.EventHandler(this._narrationAudioCheckBox_CheckedChanged);
			// 
			...
			// _helpPanel
			// 
			this._helpPanel.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
			this._helpPanel.Controls.Add(this._helpLabel);
			this._helpPanel.Controls.Add(this._helpLink);
			this._helpPanel.Location = new System.Drawing.Point(43, 606);
			this._helpPanel.Name = "_helpPanel";
			this._helpPanel.Size = new System.Drawing.Size(600, 44);
			this._helpPanel.TabIndex = 40;
			// 
			// tableLayoutPanel1
			// 
			...
			this.tableLayoutPanel1.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.tableLayoutPanel1.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.tableLayoutPanel1.Size = new System.Drawing.Size(610, 588);
			...
			this.Controls.Add(this._helpPanel);
			...
			this.Size = new System.Drawing.Size(694, 650);
			((System.ComponentModel.ISupportInitialize)(this._L10NSharpExtender)).EndInit();
			this._helpPanel.ResumeLayout(false);
			this._helpPanel.PerformLayout();
		...
		private System.Windows.Forms.Panel _helpPanel;
	}
}
