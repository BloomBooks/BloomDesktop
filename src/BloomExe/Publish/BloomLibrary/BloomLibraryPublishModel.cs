...
namespace Bloom.Publish.BloomLibrary
{
	public class BloomLibraryPublishModel
	{
		...
		internal string CCLicenseUrl => ((CreativeCommonsLicense) _license)?.Url;
		...
		/// <summary>
		/// Need a static test before we start a bulk upload.
		/// </summary>
		/// <param name="transfer"></param>
		/// <returns></returns>
		internal static bool BloomVersionTooOldToUpload(BookTransfer transfer)
		{
			return !transfer.IsThisVersionAllowedToUpload();
		}
