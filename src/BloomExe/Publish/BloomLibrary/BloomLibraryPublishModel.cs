    ...
    public class BloomLibraryPublishModel
    {
        ...
        )
        {
            ...
            if (File.Exists(filePath))
            {
                ...
                var instanceId = bookOfCollectionData["bookInstanceId"];
                ...
                if (bookFolder == pathToBookFolder.Replace("\\", "/"))
                {
                    var matchingBook = books.FirstOrDefault(
                        b => b["id"] == databaseId && b["bookInstanceId"] == instanceId
                    );
        ...
        )
        {
            ...
            return new
            {
                ...
                existingBookUrl,
                existingThumbUrl,
                uploader = existingBookInfo.uploader.email, // typically an email
        ...
        internal bool ChangeBookId(IProgress progress)
        {
            if (!Book.BookInfo.CanChangeId)
            {
