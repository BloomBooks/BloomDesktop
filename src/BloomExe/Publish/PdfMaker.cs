...
namespace Bloom.Publish
{
	...
	public class PdfMaker
	{
		...
		/// <param name="singlePageMode">true if PDF file is to be produced one page at a time</param>
		...
		public void MakePdf(string inputHtmlPath, string outputPdfPath, string paperSizeName, bool landscape, bool singlePageMode, bool layoutPagesForRightToLeft,
			PublishModel.BookletLayoutMethod booketLayoutMethod, PublishModel.BookletPortions bookletPortion, BackgroundWorker worker, DoWorkEventArgs doWorkEventArgs, Control owner)
		{
			...
			for (int i = 0; i < 4; i++)
			{
				new MakePdfUsingGeckofxHtmlToPdfProgram().MakePdf(inputHtmlPath, outputPdfPath, paperSizeName, landscape, singlePageMode,
