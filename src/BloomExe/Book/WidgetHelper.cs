...
namespace Bloom.Book
{
	...
	{
		public static UrlPathString AddWidgetFilesToBookFolder(string bookFolderPath, string fullWidgetPath)
		{
			...
			return UrlPathString.CreateFromUnencodedString("activities" + "/" + widgetName + "/" + rootFileName);
		}
		...
		/// </remarks>
		public static string CreateWidgetFromHtmlFolder(string fullWidgetPath, bool ensureIndexHtmlFileName = true)
		{
