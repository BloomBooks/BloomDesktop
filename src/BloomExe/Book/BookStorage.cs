...
namespace Bloom.Book
{
    ...
    public class BookStorage : IBookStorage
    {
        ...
        private static void ReportEmptyMarginBox(XmlElement pageDocument)
        {
            ...
            // Not an image file, but we want it included in the problem report.
            exception.Data["ProblemImagePath"] = logpath;
            var msg =
                LocalizationManager.GetDynamicString(
                    "BloomLowPriority",
                    "ProblemReport.EmptyMarginBox",
                    "The page has lost all content in the marginBox div."
                ) + " (BL-13120, BL-13123)";
