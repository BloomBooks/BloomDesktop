...
namespace Bloom.Book
{
	...
	public class BookStorage : IBookStorage
	{
		...
		public void CleanupUnusedActivities()
		{
			...
			var activityFrames = Dom.SafeSelectNodes("//*[contains(@class, 'bloom-widgetContainer')]/iframe");
			var wantedFolders = new HashSet<string>();
			foreach (XmlElement frame in activityFrames)
			{
				var src = frame.Attributes["src"]?.Value ?? "";
				var folder = Path.GetFileName(Path.GetDirectoryName(src));
