...
namespace Bloom.Book
{
    ...
    public class BookStorage : IBookStorage
    {
        ...
        ///   Bloom 6.4 15 = store audio highlight user styles in both CSS variables and legacy color properties
        ...
        public void MigrateToLevel15AudioHighlightCssVariables()
        {
            ...
            if (userStylesNode != null)
                HtmlDom.EnsureAudioHighlightRulesUseCssVariablesAndLegacyColors(userStylesNode);
