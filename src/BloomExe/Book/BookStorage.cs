	...
	public class BookStorage : IBookStorage
	{
		...
		public string FolderName
		{
			get
			{
				...
				/// GetDirectoryName will get the parent directory (which we don't want) if the FolderPath ends with "/",
				/// // but would return the desired result is the FolderPath does end with "/"
