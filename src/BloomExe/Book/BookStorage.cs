...
//				    }
		...
		public void RepairEmptyPages()
		{
			...
			if (problems.Count == 0)
				return;
			var pathToBasicBookFolder = BloomFileLocator.GetFactoryBookTemplateDirectory("Basic Book");
			...
			var justTextPage = dom.SelectSingleNode("//div[@id='a31c38d8-c1cb-4eb9-951b-d2840f6a8bdb']");
			...
			editable.InnerText = "Sorry...Bloom messed up this page.";
			...
			{
				page.ParentNode.ReplaceChild(page.OwnerDocument.ImportNode(justTextPage,true), page);
			}
		}
