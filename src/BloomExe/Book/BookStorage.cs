...
namespace Bloom.Book
{
	...
	public class BookStorage : IBookStorage
	{
		...
		public void CleanupUnusedAudioFiles()
		{
			...
			//has been applied to the document.
			toRemove.AddRange(from XmlElement dataDivAudio in Dom.RawDom.SelectNodes("//div[@id='bloomDataDiv']//div[contains(text(),'audio-sentence') or contains(text(),'data-backgroundaudio')]")
