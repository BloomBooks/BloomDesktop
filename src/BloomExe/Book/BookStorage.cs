...
namespace Bloom.Book
{
	...
	public class BookStorage : IBookStorage
	{
		...
		public void SaveForPageChanged(string pageId, XmlElement modifiedPage)
		{
			...
			var copy = doc.ImportNode(modifiedPage, true);
			body.AppendChild(copy);
			string docHtml = XmlHtmlConverter.ConvertDomToHtml5(doc);
			...
			var pageHtml = docHtml.Substring(start, endBodyIndex - start);
				...
				switch (state)
				{
					...
					case SearchState.LookForNextPageClass:
						...
						if (c == '>')
						{
							...
							state = SearchState.LookForNextPageDiv;
							pending = ""; // don't output, part of replaced page
							matchNext = "<div";
							matchIndex = 0;
							continue;
						}
