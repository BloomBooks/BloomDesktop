...
namespace Bloom.Book
{
	...
	public class BookStorage : IBookStorage
	{
		...
		public void SaveForPageChanged(string pageId, XmlElement modifiedPage)
		{
			...
			RetryUtility.Retry(() => {
				using (var reader = new StreamReader(ToPalaso.RobustIO.OpenFile(PathToExistingHtml, FileMode.Open), Encoding.UTF8))
				{
					using (var writer = new StreamWriter(ToPalaso.RobustIO.OpenFile(tempPath, FileMode.Create), Encoding.UTF8))
					{
