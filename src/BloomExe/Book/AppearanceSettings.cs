...
public class AppearanceSettings
{
    ...
    public string GetThemeAndSubstituteCss(Tuple<string, string>[] cssFilesToCheck)
    {
        ...
        if (substituteAppearance != null)
        {
            ...
            // make all our settings match what's saved there.
            // When this object is saved, not only will those settings transfer to the new book,
            // but corresponding appearance.css will be generated.
