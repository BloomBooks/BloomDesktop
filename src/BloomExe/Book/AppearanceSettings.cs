...
public class AppearanceSettings
{
    ...
    protected PropertyDef[] propertyDefinitions = new PropertyDef[]
    {
        ...
        new StringPropertyDef(kPageNumberPositionVar, "page-number", PageNumberPosition.Automatic),
        ...
        new CssStringVariableDef(kPageNumberLeftMarginOverrideVar, "page-number", kUnset),
        new CssStringVariableDef(kPageNumberRightMarginOverrideVar, "page-number", kUnset),
    ...
    public string GetCssOwnPropsDeclaration(dynamic properties, AppearanceSettings parent = null)
    {
        ...
        if (props.ContainsKey(kPageNumberPositionVar))
        {
            SetPageNumberProperties(props[kPageNumberPositionVar].ToString());
        }

        // pageNumber-show may be set by SetPageNumberProperties, or it may get set directly in a legacy situation.
    ...
    private const string kPageNumberShowVar = "pageNumber-show";
    private const string kPageNumberPositionVar = "pageNumber-position";
