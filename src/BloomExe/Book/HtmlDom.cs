...
namespace Bloom.Book
{
    ...
    public class HtmlDom
    {
        ...
        {
            AddStyleSheetsWithoutSorting(paths);
            SortStyleSheetLinks();
        }
        ...
        private bool AddStyleSheetWithoutSorting(string path)
        {
            ...
            foreach (XmlElement linkNode in RawDom.SafeSelectNodes("/html/head/link"))
            {
                ...
                if (filename.Replace('\\', '/') == pathToCheck)
                    return false;
            }
        ...
        */
        ...
        )
        {
            ...
            // TODO review: is this a faithful change
            targetBookDom.AddStyleSheets(sourceBookDom.GetTemplateStyleSheets().ToArray());
            targetBookDom.SortStyleSheetLinks();
            return anyAdded;
        }
