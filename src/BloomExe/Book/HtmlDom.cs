...
namespace Bloom.Book
{
	...
	public class HtmlDom
	{
		...
		*/
		...
		internal static void StripUnusedTagsPreservingText(XmlDocument dom, XmlNode element, string[] tagsToPreserve)
		{
			if (element.HasChildNodes)
			{
				...
				for (var i = 0; i < countOfChildren; i++)
				{
					...
					StripUnusedTagsPreservingText(dom, childNode, tagsToPreserve);
				}
			}
