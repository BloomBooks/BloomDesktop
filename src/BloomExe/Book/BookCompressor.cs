...
namespace Bloom.Book
{
	public class BookCompressor
	{
		...
		{
			CompressDirectory(outputPath, book.FolderPath, "", reduceImages:true, omitMetaJson: true, omitBookDirectory:true);
		}

		public static void CompressDirectory(string outputPath, string directoryToCompress, string dirNamePrefix,
			bool forReaderTools = false, bool excludeAudio = false, bool reduceImages = false, bool omitMetaJson = false, bool omitBookDirectory = false)
		{
