...
namespace Bloom.Book
{
    ...
    public static class TranslationGroupManager
    {
        ...
        /// <summary>
        /// If this field's visibility is controlled by the appearance system, add a class indicating its order within the
        /// collection languages that are visible for this field. Unlike in legacy, the order, like the visibility choice,
        /// does not depend on what languages are chosen in the language combo to appear in content pages.
