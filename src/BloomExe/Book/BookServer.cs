...
namespace Bloom.Book
{
	public class BookServer
	{
		...
		public virtual Book GetBookFromBookInfo(BookInfo bookInfo, bool fixBookCompletely = false)
		{
			...
			var book = _bookFactory(bookInfo, _storageFactory(bookInfo.FolderPath, fixBookCompletely));
			return book;
		}
