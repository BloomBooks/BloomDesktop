...
namespace Bloom.Book
{
	...
	public class BookCopyrightAndLicense
	{
		...
		public static Metadata GetMetadata(HtmlDom dom, string brandingNameOrFolderPath = "")
		{
			...
			{
				return SetToDefaultCopyrightAndLicense(brandingNameOrFolderPath);
			}
		...
		private static Metadata SetToDefaultCopyrightAndLicense(string brandingNameOrPath)
		{
			var metadata = new Metadata();
			...
			//OK, that's all we need, the reset is blank. That is, unless we are we are working with a brand
