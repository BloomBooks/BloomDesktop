...
//        }
		...
		public string GetCoverImagePath()
		{
			...
			// "doesn't have the data in the form that GetImageElementUrl can handle." Fortunately, just testing
			// for not having an id on a div is sufficient to rule out being in the dataDiv.
			var coverImgElt = Storage.Dom.SafeSelectNodes("//div[not(@id)]/div[@data-book='coverImage']")
				.Cast<XmlElement>()
				.FirstOrDefault();
