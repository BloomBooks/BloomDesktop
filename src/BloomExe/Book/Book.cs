                ...
                if (meta.GetAttribute("name") == "Generator")
                {
                    ...
                    if (match.Success)
                    {
                        ...
                        if (version.Major < 6)
                        {
                            ...
                            // Merely adding a link to appearance.css would often work, but a number of books in
                            // bloomlibrary.org have custom stylesheets that are not compatible with the appearance
                            // system introduced in 6.0.  So this is safer for previewing downloaded  books.
