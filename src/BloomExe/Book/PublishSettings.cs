...
namespace Bloom.Book
{
    ...
    public class PublishSettings
    {
        ...
        public AudioVideoSettings AudioVideo;

        [JsonProperty("epub")]
        public EpubSettings Epub;
        ...
        public void LoadNewJson(string json)
        {
            ...
            {
                throw new ApplicationException("publish-settings of this book may be corrupt", e);
            }
        }
        ...
        static PublishSettings MigrateFromOldMetaJson(string bookFolderPath)
        {
            ...
            try
            {
                ...
                if (metaDataJson.TryGetValue("epub_HowToPublishImageDescriptions", out double val2))
                {
                    ...
                    if (val2 != 0)
                        settings.Epub.HowToPublishImageDescriptions = BookInfo
                ...
                if (metaDataJson.TryGet("textLangsToPublish", out DynamicJson langs))
                {
                    if (
                        langs.TryGet(
                            "bloomPUB",
                            out Dictionary<string, InclusionSetting> forBloomPub
                        )
                    )
                    ...
                    if (
                        langs.TryGet(
                            "bloomLibrary",
                            out Dictionary<string, InclusionSetting> forBloomLibrary
                        )
                    )
    ...
    public class AudioVideoSettings
    {
        ...
        {
            get { return PageTurnDelay / 1000.0; }
            set { PageTurnDelay = (int)Math.Round(value * 1000); }
        }
    ...
    public class EpubSettings
    {
        ...
        {
            return other == null
                || HowToPublishImageDescriptions != other.HowToPublishImageDescriptions
