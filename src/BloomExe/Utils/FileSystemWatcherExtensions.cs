...
namespace Bloom.Utils
{
	...
	{
		public static IDisposable DebounceAnyEvent(this FileSystemWatcher source,
		...
		public static IDisposable DebounceAllEvents(this FileSystemWatcher source,
			FileSystemEventHandler handler, int delay)
			=> DebounceAnyEvent(source, WatcherChangeTypes.All, handler, delay);

		public static IDisposable DebounceCreated(this FileSystemWatcher source,
			FileSystemEventHandler handler, int delay)
			=> DebounceAnyEvent(source, WatcherChangeTypes.Created, handler, delay);

		public static IDisposable DebounceDeleted(this FileSystemWatcher source,
			FileSystemEventHandler handler, int delay)
			=> DebounceAnyEvent(source, WatcherChangeTypes.Deleted, handler, delay);

		public static IDisposable DebounceChanged(this FileSystemWatcher source,
			FileSystemEventHandler handler, int delay)
			=> DebounceAnyEvent(source, WatcherChangeTypes.Changed, handler, delay);

		public static IDisposable DebounceRenamed(this FileSystemWatcher source,
			FileSystemEventHandler handler, int delay)
