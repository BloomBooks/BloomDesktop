...
namespace Bloom.Utils
{
	...
	public class BloomTarArchive: BloomArchiveFile
	{
		...
		/// </summary>
		/// <param name="compress">This parameter is ignored because tar files don't support compression. It is recommended to pass "false" though.</param>
		protected override void AddFile(string path, string entryName, bool compress)
		{
