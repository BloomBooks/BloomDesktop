...
namespace Bloom.Utils
{
    public static class TextUtils
    {
        ...
        public static string EscapeForWinForms(string text, bool useMnemonic) =>
            useMnemonic ? text?.Replace("&", "&&") : text;

        public static string UnescapeWinForms(string text, bool useMnemonic) =>
            useMnemonic ? text?.Replace("&&", "&") : text;
    }
}
