...
namespace Bloom.Utils
{
	...
	internal static class LongPathAware
	{
		...
		internal static string GetLongPath(string path)
		{
			...
			{
				throw new ApplicationException("GetLongPath() excedeed capacity.");
			}
		...
		{
			return L10NSharp.LocalizationManager.GetString("PathTooLong", "Please move your collection closer to the root of your hard drive and try again. A file Bloom was working with had a path that was too long. This is usually caused by your collection being too deeply nested in many folders on your hard drive.");
		}
		...
		{
			ErrorReport.NotifyUserOfProblem($"{GetGenericPathTooLongMessage()} Path was '{path}'.");
		}
