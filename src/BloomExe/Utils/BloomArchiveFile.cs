...
namespace Bloom.Utils
{
	...
	public abstract class BloomArchiveFile
	{
		...
		/// <param name="compress">True to compress the file, if compression is enabled.</param>
		protected abstract void AddFile(string path, string entryName, bool compress=true);
