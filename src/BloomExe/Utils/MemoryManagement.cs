	...
	public static class MemoryManagement
	{
		...
		public static bool CheckMemory(bool minor, string eventDescription, bool okToBotherUser, bool forceFullCollection = true)
		{
			...
			using (var proc = Process.GetCurrentProcess())
			{
				...
				bldr.AppendFormat(" Memory Use ({0}-bit process): private {1:N0}K, virtual {2:N0}K,", Environment.Is64BitProcess ? 64 : 32, memorySize64/1024, virtualMemory64/1024);
			...
			var safelimit = Environment.Is64BitProcess ?
				4000000000L :   // may not be low of memory, but that's way too much memory to handle...
				(Environment.Is64BitOperatingSystem ?
					2000000000L :   // Bloom is "Large Address Aware", so allow about half of the address space
					1000000000L);
