...
namespace Bloom.CollectionTab
{
	public partial class BloomLibraryLinkVerification : Form
	{
		...
		private void Initialize()
		{
			...
			var msg = "Note: The Bloom Library contains shell books." + Environment.NewLine + Environment.NewLine;
			msg += "Your current collection is a \"source collection\", meaning it is for making shell books," + Environment.NewLine;
