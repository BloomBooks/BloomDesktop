	...
	public class FontMetadata
	{
		...
		public FontMetadata(string name, FontGroup group)
		{
			...
			if (!String.IsNullOrEmpty(license))
				Console.WriteLine("Font=\"{0}\": License=\"{1}\"", name, license.Replace('\n', ' ').Replace('\r', ' '));
			else
				Console.WriteLine("Font=\"{0}\": License is null", name);
			...
			if (!String.IsNullOrEmpty(copyright))
			{
				...
				if (copyright.Contains("This font is free; you can redistribute it and/or modify it under the terms of the Artistic License."))
				{
					determinedSuitability = "ok";
