...
<div class=""bloom-translationGroup "" data-default-languages=""auto"" data-test-id=""tg{0}"">
   <div class=""bloom-editable normal-style"" style="""" lang=""z"" contenteditable=""true"">
	...
	{1}
        ...
        static string BloomCanvasWithCanvasElement(int icNumber)
        {
            return String.Format(
        ...
        public static string PageWith2ImagesAnd2TextsWithCanvasElement(
            int pageNumber,
            int tgNumber,
            int icNumber
        )
...
<div class=""checkbox-and-textbox-choice empty"">
    ...
    <div class=""placeToPutVariableCircle""></div>
        ...
        <div class=""marginBox"">
            ...
            <div class=""bloom-canvas bloom-background-image-in-style-attr"" data-book=""coverImage"" style=""background-image:url('Othello 199.jpg')"" data-copyright=""Copyright, SIL International 2009."" data-creator="""" data-license=""cc-by-nd"">
				<div class=""bloom-translationGroup bloom-imageDescription bloom-trailingElement"" data-default-languages=""auto"">
					<div class=""bloom-editable ImageDescriptionEdit-style"" lang=""z"" contenteditable=""true"" data-book=""coverImageDescription""></div>
				</div>
			</div>
...
";
    ...
    public class SpreadsheetImageAndTextImportToBookWithComplexLastPageCanvasElementTests
    {
        private HtmlDom _dom;
        ...
        public async Task OneTimeSetUp()
        {
            ...
            var xml = string.Format(
                SpreadsheetImageAndTextImportTests.templateDom,
                SpreadsheetImageAndTextImportTests.coverPage
                    + SpreadsheetImageAndTextImportTests.PageWith2ImagesAnd2TextsWithCanvasElement(
                        1,
                        1,
                        1
                    )
            ...
            _bookFolder = new TemporaryFolder(
                "SpreadsheetImageAndTextImportToBookWithComplexLastPageCanvasElementTests"
            );
