...
namespace BloomTests.Spreadsheet
{
	...
	public class SpreadsheetImporterChangeLanguageTests
	{
		...
		// German is not in the spreadsheet. In this test class, which runs the import with RemoveOtherLanguages false, German should be kept.
		// We have another test class, a subclass of this, which runs the same import with RemoveOtherLanguages true.
		// It overrides this method to verify that in that situation, German is removed.
		[Test]
		public virtual void GermanKept_IffOnRemoveOtherLanguagesIsFalse()
		{
			var assertDom = AssertThatXmlIn.Dom(_dom.RawDom);
	...
	public class SpreadsheetImporterChangeLanguageCleanTests : SpreadsheetImporterChangeLanguageTests
	{
		...
		[Test]
		public override void GermanKept_IffOnRemoveOtherLanguagesIsFalse()
		{
		var assertDom = AssertThatXmlIn.Dom(_dom.RawDom);
