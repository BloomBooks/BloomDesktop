...
namespace BloomTests.Spreadsheet
{
	...
	public class SpreadsheetImporterChangeLanguageTests
	{
		...
		public void OneTimeSetUp()
		{
			...
			var indexDe = _sheet.GetColumnForLang("de");
			...
			var engColumn = _sheet.GetColumnForLang("en");
			...
			var frColumn = _sheet.GetColumnForLang("fr");
			...
			var asteriskColumn = _sheet.GetColumnForLang("*");
			...
			thirdXmatterRowToModify.SetCell(_sheet.GetColumnForLang("fr"), "");
			thirdXmatterRowToModify.SetCell(_sheet.GetColumnForLang("tpi"), "");
			thirdXmatterRowToModify.SetCell(_sheet.GetColumnForLang("en"), "<p>This is Not the End of the English World</p>");
...
";
		...
		public void OneTimeSetUp()
		{
			...
			_sheet.SetColumnForLang("en", "English");
			_sheet.SetColumnForLang("fr", "French");
			_sheet.SetColumnForLang("*", "*");
