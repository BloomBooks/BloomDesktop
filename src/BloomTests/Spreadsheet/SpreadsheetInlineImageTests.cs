...
namespace BloomTests.Spreadsheet
{
    ...
    public class SpreadsheetInlineImageTests
    {
        ...
        private const string floatWrapper =
            @"<div data-bloom-inline-image-id=""ii-float"" data-inline-image-offset-basedon=""380,300"" class=""bloom-inlineImage bloom-inlineImageRight bloom-keepFirstInField bloom-preventRemoval"" contenteditable=""false"" style=""--inline-image-width: 40%; --inline-image-aspect-ratio: 800 / 600; --inline-image-offset: 24px;""><img src=""flower.jpg"" alt=""""></img></div>";
...
";
        ...
        public void SheetHasInlineImageRowsAfterTheirGroupRow()
        {
            ...
            Assert.That(
                ...
                Is.EqualTo(
                    "{\"kind\":\"inline-image\",\"location\":\"right\",\"offset\":\"24px\",\"offsetBasedOn\":\"380,300\",\"width\":\"40%\"}"
                )
            );
            Assert.That(
                rows[group1Index + 2]
