...
";
        ...
        public void LanguageCellsCarryNoPictureMarkup()
        {
            ...
            // markup has no business in the language cell as well -- and in the cell it does
            // real harm: with RetainMarkup the import writes the cell back verbatim, which puts
            // the old wrappers into the editable, and StampInlineImages then leaves them alone
            // (it will not stamp over pictures that are already there). Every change made
            // through the picture rows, deletions included, was silently ignored.
