...
<body data-l1=""es"" data-l2="""" data-l3="""">
    <div id=""bloomDataDiv"">
		...
		{
			SetupFor(source);
			var starLangCol = _sheet.GetColumnForLang("*");
		...
		public void MultilingualXmatterTest(string source)
		{
			...
			Assert.That(contentLangRow.GetCell(_sheet.GetColumnForLang("es")).Content, Is.EqualTo("<p>Spanish Microwave</p>"));
			Assert.That(contentLangRow.GetCell(_sheet.GetColumnForLang("en")).Content, Is.EqualTo("<p>English Microwave</p>"));
		}
