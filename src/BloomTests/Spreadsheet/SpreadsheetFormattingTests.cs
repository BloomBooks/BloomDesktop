...
namespace BloomTests.Spreadsheet
{
	...
	public class ParseExcelCellFormattingTests
	{
		...
		public void OneTimeSetUp()
		{
			...
			AddRunToCell(firstCell, "nnn", bolded: false, italicized: false, superscripted: false, underlined: false);
			AddRunToCell(firstCell, "uuu", bolded: false, italicized: false, superscripted: false, underlined: true);
			AddRunToCell(firstCell, "nnn", bolded: false, italicized: false, superscripted: false, underlined: false);
			AddRunToCell(firstCell, "sss", bolded: false, italicized: false, superscripted: true, underlined: false);
			AddRunToCell(firstCell, "iii", bolded: false, italicized: true, superscripted: false, underlined: false);
			AddRunToCell(firstCell, "bbb", bolded: true, italicized: false, superscripted: false, underlined: false);

			ExcelRange secondCell = _worksheet.Cells[2, 2];
			secondCell.IsRichText = true;
			AddRunToCell(secondCell, "We wish ", bolded: true, italicized: false, superscripted: false, underlined: false);
			AddRunToCell(secondCell, "you", bolded: true, italicized: true, superscripted: true, underlined: false);
			AddRunToCell(secondCell, " a merry ", bolded: true, italicized: true, superscripted: true, underlined: true);
			AddRunToCell(secondCell, "Chri", bolded: true, italicized: true, superscripted: true, underlined: false);
			AddRunToCell(secondCell, "stmas", bolded: true, italicized: true, superscripted: false, underlined: false);

			ExcelRange thirdCell = _worksheet.Cells[3, 3];
			thirdCell.IsRichText = true;
			AddRunToCell(thirdCell, "\r\nApples\r\nBananas\r\n", bolded: true, italicized: false, superscripted: false, underlined: false);
			AddRunToCell(thirdCell, "Cherries\r\n\r\nDurian", bolded: false, italicized: true, superscripted: false, underlined: false);
		...
		public void BuildsXmlSimple()
		{
			...
			Assert.That(xmlString, Is.EqualTo("<p>nnn<u>uuu</u>nnn<sup>sss</sup><em>iii</em><strong>bbb</strong></p>"));
		}
		...
		public void BuildsXmlParagraphs()
		{
			...
			Assert.That(Regex.IsMatch(xmlString, "<p><\\/p><p><strong>Apples<\\/strong><\\/p><p><strong>Bananas.*"));
			Assert.That(Regex.IsMatch(xmlString, "Bananas<\\/strong><\\/p><p><em>Cherries<\\/em><\\/p><p></p><p><em>Durian<\\/em></p>"));
		}
		...
		public void BuildsXmlNested()
		{
			...
			string possibleExpected = "<p><strong>We wish </strong><strong><em><sup>you</sup></em></strong><strong><em><sup><u> a merry </u></sup></em></strong><strong><em><sup>Chri</sup></em></strong><strong><em>stmas</em></strong></p>";

			string boldRegex = "<p><strong>We wish <\\/strong>.*<strong>.*you.*<\\/strong>.*<strong>.* a merry .*<\\/strong>.*<strong>.*Chri.*<\\/strong>.*<strong>.*stmas.*<\\/strong>.*</p>";
			string italicRegex = "<p>.*We wish .*<em>.*you.*<\\/em>.*<em>.* a merry .*<\\/em>.*<em>.*Chri.*<\\/em>.*<em>.*stmas.*<\\/em>.*</p>";
			string underlineRegex = "<p>.*We wish .*you.*<u>.* a merry .*<\\/u>.*Chri.*stmas.*</p>";
			string superscriptRegex = "<p>.*We wish .*<sup>.*you.*<\\/sup>.*<sup>.* a merry .*<\\/sup>.*<sup>.*Chri.*<\\/sup>.*stmas.*</p>";
