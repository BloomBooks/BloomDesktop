...
namespace BloomTests.web
{
	...
	public class EnhancedImageServerTests
	{
		...
		public void Setup()
		{
			...
			_fileLocator = new BloomFileLocator(cs, new XMatterPackFinder(new string[] { BloomFileLocator.GetBrowserDirectory("xMatter") }), ProjectContext.GetFactoryFileLocations(),
