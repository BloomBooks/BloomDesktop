...
namespace BloomTests.web.controllers
{
    public class AudioSegmentationApiTests
    {
        ...
        {
            string inputJson =
                "{\"audioFilenameBase\":\"id0\",\"audioTextFragments\":[{\"fragmentText\":\"Sentence 1.\",\"id\":\"id1\"},{\"fragmentText\":\"Sentence 2.\",\"id\":\"id2\"},{\"fragmentText\":\"Sentence 3.\",\"id\":\"id3\"}],\"lang\":\"es\"}";
            ...
            {
                Assert.That(
                    request.audioTextFragments[i].fragmentText,
                    Is.EqualTo($"Sentence {i + 1}.")
                );
        ...
        public void ApplyOrthographyConversion_Ascii_MapJToY()
        {
            ...
            // System Under Test
            List<string> mappedFragments = AudioSegmentationApi
                .ApplyOrthographyConversion(fragments, tempFileName)
                .ToList();
        ...
        public void ApplyOrthographyConversion_NonAscii_SpecialCharsRecognizedAndConverted(
            string encodingStr
        )
        {
            ...
            if (encodingStr == "utf8")
            {
                ...
                encodingStr.Equals("Unicode", StringComparison.OrdinalIgnoreCase)
                || encodingStr == "utf16"
                || encodingStr == "utf16le"
            )
            {
                ...
                encodingStr.Equals("BigEndianUnicode", StringComparison.OrdinalIgnoreCase)
                || encodingStr == "utf16be"
            )
            {
            ...
            string[] lines = new string[] { "ά\ta", "λ\tl", "φ\tph", "α\ta" };
