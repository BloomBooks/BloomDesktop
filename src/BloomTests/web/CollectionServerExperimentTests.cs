...
{
	[TestFixture, Ignore]
	public class CollectionServerExperimentTests
	{
...
//				BookStorageFactory, null, null, new CreateFromSourceBookCommand(), new EditBookCommand());
		...
		private CollectionServerExperiment CreateBloomServer()
		{
			return new CollectionServerExperiment(_librarySettings.Object, _vernacularLibraryCollection.Object, _storeCollectionList.Object,null);
		}
