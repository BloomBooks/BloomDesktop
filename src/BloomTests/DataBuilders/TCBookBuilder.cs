...
namespace BloomTests.DataBuilders
{
	...
	class TCBookBuilder
	{
		...
		/// </summary>
		public TCBookBuilder WithTestValues()
		{
		...
		public TCBookBuilder WithRootFolder(string containingFolder)
		{
			this._containingFolder = containingFolder;
			return this;
		}

		public TCBookBuilder WithBookFolderName(string folderName)
		{
			this._bookFolderName = folderName;
			return this;
		}

		public TCBookBuilder WithTitle(string title)
		{
			this._bookTitle = title;
			return this;
		}

		public TCBookBuilder WithHtm(string htmContents)
		{
