...
namespace BloomTests.DataBuilders
{
	...
	class TCBookBuilder
	{
		...
		public TCBookBuilder SetRootFolder(string containingFolder)
		{
			this._containingFolder = containingFolder;
			return this;
		}

		public TCBookBuilder SetBookFolderName(string folderName)
		{
			this._bookFolderName = folderName;
			return this;
		}

		public TCBookBuilder SetTitle(string title)
		{
			this._bookTitle = title;
			return this;
		}

		public TCBookBuilder SetHtm(string htmContents)
		{
