...
namespace BloomTests.DataBuilders
{
    ...
    class TeamCollectionApiBuilder
    {
        ...
        public TeamCollectionApiBuilder WithCollectionSettings(
        ...
        public TeamCollectionApiBuilder WithTeamCollectionManager(
            ITeamCollectionManager teamCollectionManager
        )
        {
        ...
        public TeamCollectionApiBuilder WithBloomWebSocketServer(
