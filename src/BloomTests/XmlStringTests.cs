...
namespace BloomTests
{
    ...
    class XmlStringTests
    {
        ...
        [TestCase("AT&T", "AT&amp;T")]
        [TestCase("1 < 2", "1 &lt; 2")]
        public void FromUnencoded_GivenText_ThenEncodesText(
            string unencodedInput,
            string expectedXml
        )
        {
        ...
        public void UnencodedProperty_GivenEncodedChars_DecodesXml(
            string xmlInput,
            string expectedUnencoded
        )
        {
