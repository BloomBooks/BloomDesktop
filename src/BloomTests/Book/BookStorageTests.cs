...
<div class=""A5Portrait bloom-page numberedPage customPage"">
  <div class=""marginBox"">
      ...
      <div class=""pageDescription"" lang=""en""></div>
			...
			{
				var tgs = repairedPage.SafeSelectNodes(".//div[contains(@class,'bloom-translationGroup')]");
				Assert.That(tgs.Count, Is.EqualTo(1));
				var editables = tgs[0].SafeSelectNodes(".//div[contains(@class,'bloom-editable')]").Cast<XmlElement>()
					.ToList();
				Assert.That(editables.Count, Is.GreaterThanOrEqualTo(1));
				var L1Editable = editables.FirstOrDefault(e => e.GetAttribute("lang") == "de");
				Assert.That(L1Editable, Is.Not.Null);
				Assert.That(L1Editable.InnerText, Does.Contain("Sorry...Bloom messed up this page."));
			}
		}
	...
	<div class=""A5Portrait bloom-page numberedPage customPage"" data-page=""extra"" id=""adcd48df-e9ab-4a07-afd4-6a24d0398385"">
	  ...
	  <div>
		  <div class=""marginBox"">
			...
			Assert.That(storage.Dom.RawDom.InnerText, Does.Not.Contain("Sorry...Bloom messed up this page."));
		}
