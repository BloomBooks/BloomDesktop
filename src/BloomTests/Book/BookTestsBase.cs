...
namespace BloomTests.Book
{
    public class BookTestsBase
    {
        ...
        protected Mock<IBookStorage> MakeMockStorage(string tempFolderPath, Func<HtmlDom> domGetter)
        {
            ...
            storage
                .Setup(x => x.GetRelocatableCopyOfDom(It.IsAny<bool>()))
        ...
        {
            var bookHtml = XmlHtmlConverter.CreateDocumentWithContent(bodyContent, headContent);
        ...
        private SafeXmlDocument GetThreePageDom()
        {
            ...
            dom.LoadXml(XmlHtmlConverter.CreateDocumentWithContent(ThreePageHtml, ""));
            return dom;
        }
        ...
        {
            return new HtmlDom(
                XmlHtmlConverter.CreateDocumentWithContent(bodyContent, headContent)
            );
        }
