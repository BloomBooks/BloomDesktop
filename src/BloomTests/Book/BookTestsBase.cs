...
namespace BloomTests.Book
{
	public class BookTestsBase
	{
		...
		public BookServer CreateBookServer()
		{
			...
			var starter = new BookStarter(fileLocator, (dir, fixBookCompletely) => new BookStorage(dir, fileLocator, new BookRenamedEvent(), _collectionSettings), _collectionSettings);
