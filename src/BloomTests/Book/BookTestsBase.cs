...
namespace BloomTests.Book
{
	public class BookTestsBase
	{
		...
		public virtual void Setup()
		{
			...
			_fileLocator.Setup(x => x.LocateFileWithThrow("Device-XMatter".CombineForPath("BigBook-XMatter.htm"))).Returns(xMatter.CombineForPath("Device-XMatter", "Device-XMatter.htm"));
