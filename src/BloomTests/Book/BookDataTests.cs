...
namespace BloomTests.Book
{
	...
	""presets"": [{
		...
		[Test]
		public void UpdateFieldsAndVariables_LeveledReader_CopiesLevelFromBookInfo()
		{
		...
		[Test]
		public void UpdateFieldsAndVariables_DecodableReader_CopiesStageFromBookInfo()
		{
		...
		[Test]
		public void UpdateFieldsAndVariables_NotLeveledOrDecodable_DoesNotCopyLevelOrStageFromBookInfo()
		{
			var dom = new HtmlDom(@"<html ><head></head><body>
				<div id='bloomDataDiv'>
				</div>
		...
		[Test]
		public void UpdateFieldsAndVariables_DecodableReader_SetsDecodableStageLetters()
		{
			var dom = new HtmlDom(@"<html ><head></head><body class='decodable-reader'>
				<div id='bloomDataDiv'>
				</div>
		...
		private static BookInfo GetLeveledDecodableInfo()
		{
			// just pick an arbitrary path, where we probably won't find any metadata, to create an empty one.
			var info = new BookInfo(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), true);
