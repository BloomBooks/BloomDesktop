...
<body>
    ...
    {0}
				...
				TempFile.WithFilenameInTempFolder(testBook.Title + BookCompressor.ExtensionForDeviceBloomBook))
			{
				...
				assertThatNewHtml.HasSpecifiedNumberOfMatchesForXpath("//div[@data-creator=\"Anis Ka'abu\" and @data-license='cc-by' and @data-copyright='1996 \"SIL\" PNG' and @class='bloom-imageContainer bloom-leadingElement bloom-backgroundImage' and @style=\"background-image:url('HL00\\'14-1.svg')\"]", 2);
			}
		}
