	...
	<div id='bloomDataDiv'>
		...
		<div data-book='coverImageDescription' lang='*'>
			<div data-languagetipcontent='Portuguese' aria-label='false' role='textbox' spellcheck='true' tabindex='0' class='bloom-editable ImageDescriptionEdit-style bloom-content1 bloom-visibility-code-on' contenteditable='true' lang='pt'>
				<p>A Portuguese Image Description</p>
			</div>
		...
		<div class='bloom-page  bloom-trilingual'>
			...
			<div class='bloom-translationGroup'>
				<div data-languagetipcontent='XYZ' aria-label='false' role='textbox' spellcheck='true' tabindex='0' class='bloom-editable ImageDescriptionEdit-style bloom-content1 bloom-visibility-code-on' contenteditable='true' lang='xyz'>
					<p>An XYZ Image Description</p>
				</div>
			</div>
		</div>
	</div>
			...
			// Verification
			var bloomDataDivImageDescription = (XmlElement)dom.SafeSelectNodes("//div[@id='bloomDataDiv']/div[@data-book='coverImageDescription']/div")[0];
			...
			AssertThatXmlIn.Dom(dom).HasSpecifiedNumberOfMatchesForXpath("//div[contains(@class, 'bloom-content1')]", 1);	// Should remove content1 off the dataDiv
		}
