...
<body>
	<div class='bloom-page'>
		<div class='bloom-page' id='guid2'>
			...
			Assert.That(book.RawDom.InnerXml.Contains("<p><strong><em>This is a test!</em></strong></p>"), Is.True, "new markup imposed preserving spaces");
			Assert.That(book.RawDom.InnerXml.Contains("<p><strong>Do you like green eggs and ham?\u00A0 I do not like them, Sam-I-am.\u00A0 I do not like green eggs and ham.</strong></p>"), Is.True, "new markup imposed preserving sentence spacing");
		}
