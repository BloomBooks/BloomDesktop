...
<body>
	...
	.normal-style { font-size: 9pt !important; }
		...
		[Test]
		public void DuplicatePage_WithAudioWhichWasTextBoxModeButNowSentenceMode_CopiesAudioAndAssignsNewId()
		{
			var divId = "id-div1";
			var span1Id = "id-span1";
			var span2Id = "id-span2";
			// This might look odd, but this is what it looks like after switching from Textbox mode to sentence mode
			var htmlSourceBook = $@"<html><head></head><body>
					<div class='bloom-page numberedPage bloom-nonprinting' id='page1' data-page-number='1'>
						<div id='{divId}' class='bloom-editable' data-audiorecordingmode='Sentence' >
							<p>
								<span id='{span1Id}' class='audio-sentence'>Sentence 1.</span>
								<span id='{span2Id}' class='audio-sentence'>Sentence 2.</span>
							</p>
						</div>
					</div>
				</body></html>";
