...
");
		...
		public void SetMultilingualContentLanguages_UpdatesLanguagesOfBookFieldInDOM()
		{
			...
			bookData.GetLanguage(LanguageSlot.Language1).SetName("ไทย", false);
			...
			book.SetMultilingualContentLanguages(book.GetLanguage(LanguageSlot.Language2).Iso639Code, book.GetLanguage(LanguageSlot.Language3).Iso639Code);
			...
			book.SetMultilingualContentLanguages(book.GetLanguage(LanguageSlot.Language2).Iso639Code, null);
...
<body>
	...
	.normal-style { font-size: 9pt !important; }
		...
		public void BringBookUpToDate_LanguagesOfBookUpdated()
		{
			...
			var book = CreateBook();
			book.BookData.GetLanguage(LanguageSlot.Language1).SetName("My Language Name", true);
			book.BringBookUpToDate(new NullProgress());
		...
		public void BringBookUpToDate_UpdatesRtlInMetaJson()
		{
			...
			var old = book.GetLanguage(LanguageSlot.Language1).IsRightToLeft;
			try
			{
				book.GetLanguage(LanguageSlot.Language1).IsRightToLeft = true;
				book.BringBookUpToDate(new NullProgress());
			}
			finally
			{
				book.GetLanguage(LanguageSlot.Language1).IsRightToLeft = old;
			}
