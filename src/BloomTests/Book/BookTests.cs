...
";
		...
		// Enhance: it'd be nice to have an Art-of-Reading black-white here
		//          Example:
		//          [TestCase(@"C:\ProgramData\SIL\ImageCollections\Art Of Reading\images\Brazil\aor_B-2-23.png")]
		// Enhance: it'd be nice to have an image like the page 1 image in Pretty Girl (https://dev.bloomlibrary.org/browse/detail/AaHdCjMBXW)
		//          which is a "black and white" (sort of) 1-bit colormap that is technically all black, but uses the alpha channel to encode b/w-ness
		//          This image should return not 0x000...
