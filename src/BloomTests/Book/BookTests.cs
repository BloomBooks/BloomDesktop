...
<body>
	...
	.normal-style { font-size: 9pt !important; }
        ...
        [Test]
        public void BringBookUpToDate_CustomLayoutPageHasBloomHasCustomLayout_PreservesClass()
        {
            _bookDom = new HtmlDom(
                @"
				<html>
					...
					<body>
						...
						<div class='bloom-page cover coverColor bloom-frontMatter frontCover bloom-customLayout bloom-hasCustomLayout A5Portrait side-right'
            ...
            AssertThatXmlIn
                .Dom(book.RawDom)
                .HasSpecifiedNumberOfMatchesForXpath(
                    "//div[contains(@class, 'bloom-page') and @data-custom-layout-id='customOutsideFrontCover' and contains(concat(' ', normalize-space(@class), ' '), ' bloom-hasCustomLayout ')]",
                    1
                );
        }
