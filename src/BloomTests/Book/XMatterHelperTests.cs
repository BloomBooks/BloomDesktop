...
namespace BloomTests.Book
{
	...
	public class XMatterHelperTests
	{
		...
		[TestCase("A5Portrait", "another-image.png", "another-image.png",
			new[] { "another-image.png", "another-image-landscape.svg", "another-image-landscape.png" })] // don't use either landscape image in portrait mode
		[TestCase("A5Landscape", "another-image.png", "another-image-landscape.png",
			new[] { "another-image.png", "another-image.svg", "another-image-landscape.png" })] // use landscape png, even though portrait svg exists
		[TestCase("A5Portrait", "another-image.svg", "another-image.svg",
			new[] { "another-image.png", "another-image.svg", "another-image-landscape.svg", "another-image-landscape.png" })] // portrait mode prefers portrait svg to all others
		[TestCase("A5Landscape", "another-image.svg", "another-image-landscape.svg",
			new[] { "another-image.png", "another-image.svg", "another-image-landscape.svg", "another-image-landscape.png" })] // landscape prefers landscape svg to all others
		[TestCase("A5Landscape", "another-image.png", "another-image-landscape.png",
			new[] { "another-image.png", "another-image-landscape.png" })] // prefer landscape-mode png over default png
		[TestCase("A5Landscape", "another-image.png", "another-image.png",
			new[] { "another-image.png" })] // use default png if that's all we have
		[TestCase("A5Landscape", "another-image.svg", "another-image.svg",
			...
			string expectedImageContent, string[] imageFilesToCreate)
		{
			using (var tempFolder = new TemporaryFolder("InjectXMatter_Landscape_PrefersLandscapeImage" + new Random().Next()))
			{
				...
				var layout = new Layout() { SizeAndOrientation = SizeAndOrientation.FromString(orientation) };
