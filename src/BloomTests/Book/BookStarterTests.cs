...
namespace BloomTests.Book
{
	...
	public class BookStarterTests
	{
		...
		public void Setup()
		{
			...
			_starter = new BookStarter(_fileLocator, (dir, fixBookCompletely) => new BookStorage(dir, _fileLocator, new BookRenamedEvent(), collectionSettings), _defaultCollectionSettings);
...
//        }
		...
		private BookServer CreateBookServer()
		{
			...
			}, (path, fixBookCompletely) => new BookStorage(path, _fileLocator, null, collectionSettings), () => _starter, null);
			return server;
		}
