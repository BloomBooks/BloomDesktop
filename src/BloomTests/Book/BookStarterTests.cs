...
//		}
		...
		public void CreateBookOnDiskFromTemplate_FromTranslatedMoonAndCap_HasNoCopyrightOrVersionAcknowledgements()
		{
			...
			bookdata.SetFromXmlEncoded("copyright", "Copyright 2018 some translator", "*");
			bookdata.SetFromXmlEncoded("versionAcknowledgments", "some translator worked on this", "en");
