...
namespace BloomTests.Book
{
	...
	public sealed class BookCopyrightAndLicenseTests
	{
		...
		[Test]
		public void GetMetadata_DataProvidedByBranding_GetsCorrectValuesForLanguage2()
		{
			CollectionSettings collectionSettings = new CollectionSettings {Language2Iso639Code = "yyy"};
			string dataDivContent = @"
