...
namespace BloomTests.Book
{
    ...
    public class BookStorage_ReplacePageTests
    {
        ...
        {
            using (
                var inputStream = new StreamReader(new MemoryStream(Encoding.UTF8.GetBytes(input)))
            )
        ...
        [TestCase(
            "<div id=\"prePage\">some other stuff</div>",
        ...
        [TestCase(
            "<div class=\"bloom-page\" id=\"prePage\">some other stuff</div> <div class=\"bloom-page\" id=\"anotherpage\">some other stuff</div>",
