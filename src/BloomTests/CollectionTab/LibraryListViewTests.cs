...
namespace BloomTests.CollectionTab
{
	...
	public class LibraryListViewTests
	{
		...
		public void LoadOneCollection_NonEditableCollection_BookNotSelected()
		{
			...
			_view = new LibraryListView(new FakeLibraryModel(collectionFolder), bookSelection, new SelectedTabChangedEvent(), new LocalizationChangedEvent(), new BookStatusChangeEvent(), null, null, null, null);
		...
		public void LoadOneCollection_EditableCollection_BookSelected()
		{
			...
			_view = new LibraryListView(new FakeLibraryModel(collectionFolder), bookSelection, new SelectedTabChangedEvent(), new LocalizationChangedEvent()
				, new BookStatusChangeEvent(), null, null, null, null);
		...
		public void OnTeamCollectionBookStatusChange_TeamCollection_CheckedOutBySelf()
		{
			...
			_view = new LibraryListView(new FakeLibraryModel(collectionFolder), new BookSelection(), new SelectedTabChangedEvent(),
				new LocalizationChangedEvent(), new BookStatusChangeEvent(), teamCollectionManager, null, null, null);
		...
		public void OnTeamCollectionBookStatusChange_TeamCollection_CheckedOutByOther()
		{
			...
			_view = new LibraryListView(new FakeLibraryModel(collectionFolder), new BookSelection(), new SelectedTabChangedEvent(),
				new LocalizationChangedEvent(), new BookStatusChangeEvent(), null, null, null, null);
		...
		public void LoadPrimaryCollectionButtons_CollectionNameHasAmpersand_IsEscaped()
		{
			...
			_view = new LibraryListView(new FakeLibraryModel(collectionFolder, collectionSettings), new BookSelection(),
				new SelectedTabChangedEvent(), new LocalizationChangedEvent(), new BookStatusChangeEvent(), null, null, null, null);
