...
namespace BloomTests.CollectionTab
{
	...
	public class LibraryListViewTests
	{
		...
		public void LoadOneCollection_NonEditableCollection_BookNotSelected()
		{
			...
			_view = new LibraryListView(new FakeLibraryModel(collectionFolder), bookSelection, new SelectedTabChangedEvent(), new LocalizationChangedEvent(), new TeamCollectionCheckoutStatusChangeEvent());
		...
		public void OnTeamCollectionCheckoutStatusChange_TeamCollection_CheckedOutBySelf()
		{
			...
			_view = new LibraryListView(new FakeLibraryModel(collectionFolder), new BookSelection(), new SelectedTabChangedEvent(), new LocalizationChangedEvent(), new TeamCollectionCheckoutStatusChangeEvent());
