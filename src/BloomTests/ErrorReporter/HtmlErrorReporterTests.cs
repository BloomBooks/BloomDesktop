...
namespace BloomTests.ErrorReporter
{
	...
	public class HtmlErrorReporterTests
	{
		...
		public void NotifyUserOfProblemCustom_ShouldHideReportSetToDefault_ReportButtonIfNonNullException()
		{
			...
			// System Under Test
			reporter.NotifyUserOfProblemCustom("message", new ApplicationException("fake exception"));
		...
		public void NotifyUserOfProblemCustom_ShouldHideReportSetToDefault_ReportButtonHiddenIfNullException()
		{
			...
			// System Under Test
			reporter.NotifyUserOfProblemCustom("message", null);
		...
		public void NotifyUserOfProblemCustom_ShouldShowReportSetToTrue_ReportButtonPresent(string exceptionMessage)
		{
			...
			// System Under Test
			reporter.NotifyUserOfProblemCustom("message", exceptionOrNull, allowSendReport: AllowSendReport.Allow);
		...
		public void NotifyUserOfProblemCustom_ShouldShowReportSetToFalse_ReportButtonDisabled(string exceptionMessage)
		{
			...
			// System Under Test
			reporter.NotifyUserOfProblemCustom("message", exceptionOrNull, allowSendReport: AllowSendReport.Disallow);
		...
		public void IntegratationTestWithErrorReportUtils()
		{
			...
			{
				// System Under Test
				BloomErrorReport.NotifyUserOfProblemCustom("message", new ApplicationException("fake exception"), new ShowAlwaysPolicy(), AllowSendReport.Default, "Retry", ErrorReportUtils.TestAction);
