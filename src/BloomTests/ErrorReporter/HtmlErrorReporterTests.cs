...
namespace BloomTests.ErrorReporter
{
	...
	public class HtmlErrorReporterTests
	{
		...
		public void NotifyUserOfProblem_ShouldHideReportSetToDefault_ReportButtonIfNonNullException()
		{
			...
			// System Under Test
			reporter.NotifyUserOfProblem("message", new ApplicationException("fake exception"), new NotifyUserOfProblemSettings(), new ShowAlwaysPolicy());
		...
		public void NotifyUserOfProblem_ShouldHideReportSetToDefault_ReportButtonHiddenIfNullException()
		{
			...
			// System Under Test
			reporter.NotifyUserOfProblem("message", new NotifyUserOfProblemSettings(), new ShowAlwaysPolicy());
		...
		public void NotifyUserOfProblem_ShouldShowReportSetToTrue_ReportButtonPresent(string exceptionMessage)
		{
			var mockFactory = GetDefaultMockReactDialogFactory();
			var reporter = new HtmlErrorReporterBuilder()
				.WithTestValues()
			...
			// System Under Test
			reporter.NotifyUserOfProblem("message", exceptionOrNull, new NotifyUserOfProblemSettings(AllowSendReport.Allow), new ShowAlwaysPolicy());
		...
		[TestCase(null)]    // Tests that the report button label works even if exception is null)
		[TestCase("fake exception")]
		public void NotifyUserOfProblem_ShouldShowReportSetToFalse_ReportButtonDisabled(string exceptionMessage)
		{
			var mockFactory = GetDefaultMockReactDialogFactory();
			var reporter = new HtmlErrorReporterBuilder()
				.WithTestValues()
			...
			// System Under Test
			reporter.NotifyUserOfProblem("message", exceptionOrNull, new NotifyUserOfProblemSettings(AllowSendReport.Disallow), new ShowAlwaysPolicy());
		...
		public void NotifyUserOfProblem_SecondaryActionButtonLabel()
		{
			...
			// System Under Test
			reporter.NotifyUserOfProblem("message", new NotifyUserOfProblemSettings("Retry", null), new ShowAlwaysPolicy());
		...
		public void NotifyUserOfProblem_SecondaryActionAutoInvoked()
		{
			...
			{
				// System Under Test
				reporter.NotifyUserOfProblem("message", new NotifyUserOfProblemSettings("Retry", action), new ShowAlwaysPolicy());
		...
		public void IntegratationTestWithErrorReportUtils()
		{
			...
			{
				// System Under Test
				BloomErrorReport.NotifyUserOfProblem("message", new ApplicationException("fake exception"), new NotifyUserOfProblemSettings("Retry", ErrorReportUtils.TestAction), new ShowAlwaysPolicy());
