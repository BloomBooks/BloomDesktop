...
namespace BloomTests.ErrorReporter
{
	...
	public class HtmlErrorReporterTests
	{
		...
		[Test]
		public void NotifyUserOfProblemCustom_ShouldHideReportSetToDefault_ReportButtonIfNonNullException()
		{
			var mockFactory = GetDefaultMockReactDialogFactory();
			var reporter = new HtmlErrorReporterBuilder()
				.WithTestValues()
			...
			// System Under Test
			reporter.NotifyUserOfProblem("message", new ApplicationException("fake exception"));
		...
		[Test]
		public void NotifyUserOfProblemCustom_ShouldHideReportSetToDefault_ReportButtonHiddenIfNullException()
		{
			var mockFactory = GetDefaultMockReactDialogFactory();
			var reporter = new HtmlErrorReporterBuilder()
				.WithTestValues()
			...
			// System Under Test
			reporter.NotifyUserOfProblem("message", null);
		...
		public void NotifyUserOfProblemCustom_ShouldShowReportSetToTrue_ReportButtonPresent(string exceptionMessage)
		{
			var mockFactory = GetDefaultMockReactDialogFactory();
			var reporter = new HtmlErrorReporterBuilder()
				.WithTestValues()
			...
			// System Under Test
			reporter.NotifyUserOfProblem("message", exceptionOrNull, allowSendReport: AllowSendReport.Allow);
		...
		[TestCase(null)]    // Tests that the report button label works even if exception is null)
		[TestCase("fake exception")]
		public void NotifyUserOfProblemCustom_ShouldShowReportSetToFalse_ReportButtonDisabled(string exceptionMessage)
		{
			var mockFactory = GetDefaultMockReactDialogFactory();
			var reporter = new HtmlErrorReporterBuilder()
				.WithTestValues()
			...
			// System Under Test
			reporter.NotifyUserOfProblem("message", exceptionOrNull, allowSendReport: AllowSendReport.Disallow);
		...
		public void NotifyUserOfProblemCustom_SecondaryActionButtonLabel()
		{
			...
			// System Under Test
			reporter.NotifyUserOfProblem("message", extraButtonLabel: "Retry");
		...
		public void NotifyUserOfProblemCustom_SecondaryActionAutoInvoked()
		{
			...
			{
				// System Under Test
				reporter.NotifyUserOfProblem("message", extraButtonLabel: "Retry", onExtraButtonClicked: action);
		...
		public void IntegratationTestWithErrorReportUtils()
		{
			...
			{
				// System Under Test
				BloomErrorReport.NotifyUserOfProblemCustom("message", new ApplicationException("fake exception"), new ShowAlwaysPolicy(), extraButtonLabel: "Retry", onExtraButtonPressed: ErrorReportUtils.TestAction);
