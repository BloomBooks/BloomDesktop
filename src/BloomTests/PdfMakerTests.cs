...
namespace BloomTestsThatAvoidTheSetupFixture
{
	...
	public class PdfMakerTests
	{
		...
		/// </remarks>
		void RunMakePdf(PdfMaker maker, string input, string output, string paperSize, bool landscape, bool singlePageMode, bool rightToLeft,
			PublishModel.BookletLayoutMethod layout, PublishModel.BookletPortions portion)
		{
			...
			maker.MakePdf(input, output, paperSize, landscape, singlePageMode, rightToLeft, layout, portion, null, eventArgs, null);
		}
	}
}
