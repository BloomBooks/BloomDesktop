...
namespace BloomTests
{
    ...
    public class UpdateVersionTableTests
    {
        ...
        public void ThisVersionTooLarge_ReturnsEmptyString()
        {
            ...
            t.TextContentsOfTable =
                @"# the format is min,max,url
        ...
        public void LookupURLOfUpdate_NoLineForDesiredVersion_ReportsError()
        {
            ...
            Assert.That(
                ...
                Is.EqualTo(
                    "http://bloomlibrary.org/channels/UpgradeTableTestChannel.txt contains no record for this version of Bloom"
                )
            );
        }
        ...
        public void ServerAddressIsBogus_ErrorIsCorrect()
        {
            ...
            Assert.IsTrue(
                e == WebExceptionStatus.NameResolutionFailure
                    || e == WebExceptionStatus.ProtocolError
            );
        }
        ...
        [Platform(
            Exclude = "Linux",
            Reason = "Windows-specific, fails on Linux without special access setup"
        )]
        ...
        public void LookupURLOfUpdateInternal_BehindCaptivePortal_DoesNotCrash()
        {
            ...
            Assert.That(
                () => t.CanGetVersionTableFromWeb(mockClient, out errorResult),
                Throws.Nothing
            );
