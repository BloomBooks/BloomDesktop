		...
		public void SyncLocalAndRepoCollectionFiles_SyncsInRightDirection()
		{
			using (var collectionFolder = new TemporaryFolder("SyncLocalAndRepoCollectionFiles_SyncsInRightDirection_Collection"))
			{
				using (var repoFolder = new TemporaryFolder("SyncLocalAndRepoCollectionFiles_SyncsInRightDirection_Shared"))
				{
					...
					Assert.That(tc.LocalCollectionFilesSyncTime, Is.EqualTo(DateTime.MinValue));
					...
					var localWriteTime1 = tc.LocalCollectionFilesSyncTime();
					...
					tc.SyncLocalAndRepoCollectionFiles();
					var localWriteTime2 = tc.LocalCollectionFilesSyncTime();
					...
					tc.SyncLocalAndRepoCollectionFiles();
					var localWriteTime3 = tc.LocalCollectionFilesSyncTime();
					...
					tc.SyncLocalAndRepoCollectionFiles();
					var localWriteTime4 = tc.LocalCollectionFilesSyncTime();
					...
					tc.SyncLocalAndRepoCollectionFiles();
					var localWriteTime5 = tc.LocalCollectionFilesSyncTime();
					...
					tc.SyncLocalAndRepoCollectionFiles();
					var localWriteTime6 = tc.LocalCollectionFilesSyncTime();
					...
					tc.SyncLocalAndRepoCollectionFiles();
					var localWriteTime7 = tc.LocalCollectionFilesSyncTime();
