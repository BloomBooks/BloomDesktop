...
namespace BloomTests.TeamCollection
{
    ...
    {
        private static string goodParts =
            "\tTeamCollection.NewBook\tA new book {0} arrived from {1}\tMy book\tFred";

        [Test]
        public void FromPersistedForm_ValidForm_GetsData()
        {
            var msg = TeamCollectionMessage.FromPersistedForm(
                "2009-06-15T13:45:30.0000000-07:00\tError" + goodParts
            );
            ...
            Assert.That(
                ...
                Is.EqualTo("A new book {0} arrived from {1}")
            );
        ...
        {
            var msg = TeamCollectionMessage.FromPersistedForm(
                "2010-06-15T13:45:30.0000000-07:00\tReloaded"
            );
        ...
        {
            var msg = TeamCollectionMessage.FromPersistedForm(
                badForm + (appendGoodParts ? goodParts : "")
            );
