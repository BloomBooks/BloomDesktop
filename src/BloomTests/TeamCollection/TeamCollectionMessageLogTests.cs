...
namespace BloomTests.TeamCollection
{
    public class TeamCollectionMessageLogTests
    {
        ...
        private void AssertHistory2(
            List<TeamCollectionMessage> messages,
            int index,
            string title = "Ducks and Geese"
        )
        {
            AssertMessage(
                messages,
        ...
        private void AssertErrorNoReload(
            List<TeamCollectionMessage> messages,
            int index,
            string title = "Book was deleted"
        )
        {
            AssertMessage(
                messages,
        ...
        private void AssertError1(
            List<TeamCollectionMessage> messages,
            int index,
            string title = "Joe hunts pigs"
        )
        {
            AssertMessage(
                messages,
        ...
        private void AssertMessage(
            List<TeamCollectionMessage> messages,
            int index,
            MessageAndMilestoneType expectedType,
            string expectedL10n,
            string expectedMsg,
            string expectedParam0 = null,
        ...
        private static void AssertSingleMessage(
            TeamCollectionMessage msg,
            MessageAndMilestoneType expectedType,
            string expectedL10n,
            string expectedMsg,
            string expectedParam0,
            string expectedParam1
        )
        {
        ...
        private void AssertNewBookMessage(
            List<TeamCollectionMessage> messages,
            int index,
            string title = "I am new"
        )
        {
            AssertMessage(
                messages,
        ...
        private void AssertChangedBookMessage(
            List<TeamCollectionMessage> messages,
            int index,
            string title = "I am different"
        )
        {
            AssertMessage(
                messages,
        ...
        {
            _messageLog.WriteMessage(
                MessageAndMilestoneType.ClobberPending,
        ...
        private void AssertClobberMessage(
            TeamCollectionMessage message,
            string title = "I was clobbered"
        )
        {
        ...
        public void WriteMessage_RaisesStatusChanged()
        {
            ...
            Assert.That(
                ...
                Is.True,
                "TeamCollectionStatusChanged should have been raised"
            );
        }
        ...
        public void WriteMessage_GetsCurrentDateTime()
        {
            ...
            Assert.That(
                msg.When,
                Is.InRange(DateTime.UtcNow - new TimeSpan(0, 0, 0, 1), DateTime.UtcNow)
            );
        }
        ...
        public void TeamCollectionStatus_NewStuffNoErrors_NewStuff()
        {
            ...
            Assert.That(
                ...
                Is.EqualTo(TeamCollectionStatus.NewStuff)
            );
        }
