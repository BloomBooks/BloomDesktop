    ...
    public class FolderTeamCollectionTests
    {
        ...
        public void OneTimeSetup()
        {
            ...
            RobustFile.WriteAllText(
                bookPath,
                XmlHtmlConverter.CreateDocumentWithContent("This is just a dummy")
            );
            ...
            RobustFile.WriteAllText(
                anotherBookPath,
                XmlHtmlConverter.CreateDocumentWithContent("This is just a dummy for another book")
            );
        ...
        public void CopyAllBooksFromSharedToLocalFolder_RetrievesExpectedBooks_AndChecksums()
        {
            using (var destFolder = new TemporaryFolder("GetBooks_Retrieves"))
            {
                ...
                Assert.That(
                    ...
                    Is.EqualTo(XmlHtmlConverter.CreateDocumentWithContent("This is just a dummy"))
                );
                ...
                Assert.That(
                    ...
                    Is.EqualTo(
                        XmlHtmlConverter.CreateDocumentWithContent(
        ...
        public void PutBook_DoesNotRaiseNewBookEvent()
        {
            ...
            RobustFile.WriteAllText(
                bookPath,
                XmlHtmlConverter.CreateDocumentWithContent("This is our newly put book")
            );
        ...
        public void ChangedBook_RaisesBookChangedEvent()
        {
            ...
            RobustFile.WriteAllText(
                bloomBookPath,
                XmlHtmlConverter.CreateDocumentWithContent(@"This is changed")
            ); // no, not a zip at all
        ...
        public void DeletedBook_RaisesDeleteRepoBookFileEvent()
        {
            ...
            RobustFile.WriteAllText(
                bloomBookPath,
                XmlHtmlConverter.CreateDocumentWithContent(@"This is original")
            ); // no, not a zip at all
