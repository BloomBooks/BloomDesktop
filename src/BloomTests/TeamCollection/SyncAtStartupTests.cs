...
namespace BloomTests.TeamCollection
{
	public class SyncAtStartupTests
	{
		...
		{
			AssertProgress("It seems that, despite our best efforts to prevent it, two members of your team have made conflicting edits. The resulting book \"{0}\" has been moved to Lost & Found.",
