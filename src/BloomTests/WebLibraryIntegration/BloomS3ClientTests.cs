...
namespace BloomTests.WebLibraryIntegration
{
	...
	public class BloomS3ClientTests
	{
		...
		public void UploadBook_EmptyFolder_DoesntThrow()
		{
			...
			{
				_clientWhichMustWorkAroundUploadPermissions.UploadBook(storageKeyOfBookFolderParent, f.FolderPath, new NullProgress(), null, true, true, null, null, null, null);
			}
	...
	{
		public BloomS3ClientTestDouble(string bucketName, bool shouldWorkAroundUploadPermissions = false) : base(bucketName)
		{
