...
namespace BloomTests
{
	...
	class ExtensionsTests
	{
		...
		[TestCase("A,", "A%2C")]
		[TestCase("A.", "A.")]
		public static void ToLocalhostForBloomPlayer_AndroidPreviewBookTitleWithPunc_GeneratesWellFormedUrl(string bookTitle, string expectedEscapedTitle)
		{
			// Setup
			string filename = $@"C:\PathToTemp\PlaceForStagingBook\{bookTitle}\meta.json";

			// System under test
			string result = filename.ToLocalhostForBloomPlayer();
