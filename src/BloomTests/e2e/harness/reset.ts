// Resets the local stack to a known-empty state between scenarios (HARD-WON RULE #5 in
...
/** Clears every object (and all noncurrent versions) under the local bucket by running `mc rm`
