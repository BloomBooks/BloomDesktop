...
// a different LocalStackUser. "Same machine" falls out for free: every launch in this harness runs on
// the same physical/local-stack machine, so TeamCollectionManager.CurrentMachine is identical
...
import { ALICE, BOB, ADMIN } from "../harness/localStack";
import {
    postApi,
