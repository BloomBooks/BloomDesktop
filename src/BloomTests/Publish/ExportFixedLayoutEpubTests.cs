...
namespace BloomTests.Publish
{
...

	{
		...
		public void CheckEpubBasics()
		{
			...
			CheckAccessibilityInManifest(false, false, false, _defaultSourceValue.Replace("Portrait", "Landscape"), false);
		...
		{
			AssertThatXmlIn.String(_manifestContent)
				.HasSpecifiedNumberOfMatchesForXpath(
					"//metadata/meta[@property='rendition:layout' and text() = 'pre-paginated']", 1);
		}
		...
		public void SetsRenditionLandscape()
		{
			...
			AssertThatXmlIn.String(_manifestContent)
				.HasSpecifiedNumberOfMatchesForXpath(
					"//metadata/meta[@property='rendition:orientation' and text() = 'landscape']", 1);
			AssertThatXmlIn.String(_manifestContent)
				.HasSpecifiedNumberOfMatchesForXpath(
					"//metadata/meta[@property='rendition:spread' and text() = 'none']", 1);
		}
	}
}
