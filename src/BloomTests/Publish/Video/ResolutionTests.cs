...
namespace BloomTests.Publish.Video
{
    ...
    internal class ResolutionTests
    {
        ...
        public void GetInverse()
        {
            ...
            Assert.AreEqual(
                resolution.Height,
                invertedResolution.Width,
                "Inverted Resolution width should be original height"
            );
            Assert.AreEqual(
                resolution.Width,
                invertedResolution.Height,
                "Inverted Resolution height should be original width"
            );
        }
        #endregion
        ...
        public string GetAspectRatio_GivenStandardResolutions_StandardAspectRatioGenerated(
            int width,
            int height
        )
        {
        ...
        public string GetAspectRatio_GivenNonStandardResolution_FallbackAspectRatioGenerated(
            int width,
            int height
        )
        {
