...
<!-- class 'box-header-off' here pointed out a flaw in our deletion code in InvisibleAndUnwantedContentRemoved() -->
		...
		public void XMatterAndContentAriaRolesAreMarked()
		{
			...
			AssertThatXmlIn.String(_page1Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:*[@role='main']", _ns, 0);
			...
			AssertThatXmlIn.String(_page1Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:img[@aria-describedby]", _ns, 1);
			AssertThatXmlIn.String(_page1Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:img[@aria-describedby='figdesc1' and @id='bookfig1']", _ns, 1);
			AssertThatXmlIn.String(_page1Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:div[@id='figdesc1']", _ns, 1);

			var page2Data = GetZipContent(_epub, Path.GetDirectoryName(_manifestFile) + "/" + "2.xhtml");
			AssertThatXmlIn.String(page2Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:*[@role='main']", _ns, 1);
			AssertThatXmlIn.String(page2Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:*[@role='contentinfo']", _ns, 0);
			AssertThatXmlIn.String(page2Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:*[@aria-label]", _ns, 2);
			AssertThatXmlIn.String(page2Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:div[@role='main' and @aria-label='Main Content']", _ns, 1);
			AssertThatXmlIn.String(page2Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:span[@role='doc-pagebreak']", _ns, 1);
			AssertThatXmlIn.String(page2Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:span[@role='doc-pagebreak' and @aria-label='1']", _ns, 1);
			AssertThatXmlIn.String(page2Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:img[@aria-describedby]", _ns, 1);
			AssertThatXmlIn.String(page2Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:img[@aria-describedby='figdesc2' and @id='bookfig2']", _ns, 1);
			AssertThatXmlIn.String(page2Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:div[@id='figdesc2']", _ns, 1);

			var page3Data = GetZipContent(_epub, Path.GetDirectoryName(_manifestFile) + "/" + "3.xhtml");
			AssertThatXmlIn.String(page3Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:*[@role='main']", _ns, 0);
			AssertThatXmlIn.String(page3Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:*[@role='contentinfo']", _ns, 3);
			AssertThatXmlIn.String(page3Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:*[@aria-label]", _ns, 4);
			AssertThatXmlIn.String(page3Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:div[@role='contentinfo' and @aria-label='Title Page']", _ns, 1);
			AssertThatXmlIn.String(page3Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:div[@role='contentinfo' and @aria-label='Original Contributions']", _ns, 1);
			AssertThatXmlIn.String(page3Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:div[@role='contentinfo' and @aria-label='Funding']", _ns, 1);
			AssertThatXmlIn.String(page3Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:span[@role='doc-pagebreak']", _ns, 1);
			AssertThatXmlIn.String(page3Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:span[@role='doc-pagebreak' and @aria-label='Title Page']", _ns, 1);
			AssertThatXmlIn.String(page3Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:img[@aria-describedby]", _ns, 0);

			var page4Data = GetZipContent(_epub, Path.GetDirectoryName(_manifestFile) + "/" + "4.xhtml");
			AssertThatXmlIn.String(page4Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:*[@role='main']", _ns, 0);
			AssertThatXmlIn.String(page4Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:*[@role='contentinfo']", _ns, 5);
			AssertThatXmlIn.String(page4Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:*[@aria-label]", _ns, 6);
			AssertThatXmlIn.String(page4Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:div[@role='contentinfo' and @aria-label='Credits Page']", _ns, 1);
			AssertThatXmlIn.String(page4Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:div[@role='contentinfo' and @aria-label='Copyright']", _ns, 1);
			AssertThatXmlIn.String(page4Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:div[@role='contentinfo' and @aria-label='Version Acknowledgments']", _ns, 1);
			AssertThatXmlIn.String(page4Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:div[@role='contentinfo' and @aria-label='Original Copyright']", _ns, 1);
			AssertThatXmlIn.String(page4Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:div[@role='contentinfo' and @aria-label='Original Acknowledgments']", _ns, 1);
			AssertThatXmlIn.String(page4Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:span[@role='doc-pagebreak']", _ns, 1);
			AssertThatXmlIn.String(page4Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:span[@role='doc-pagebreak' and @aria-label='Credits Page']", _ns, 1);
			AssertThatXmlIn.String(page4Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:img[@aria-describedby]", _ns, 0);

			var page5Data = GetZipContent(_epub, Path.GetDirectoryName(_manifestFile) + "/" + "5.xhtml");
			AssertThatXmlIn.String(page5Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:*[@role='main']", _ns, 0);
			AssertThatXmlIn.String(page5Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:*[@role='contentinfo']", _ns, 0);
			AssertThatXmlIn.String(page5Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:*[@aria-label]", _ns, 1);
			AssertThatXmlIn.String(page5Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:span[@role='doc-pagebreak']", _ns, 1);
			AssertThatXmlIn.String(page5Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:span[@role='doc-pagebreak' and @aria-label='The End']", _ns, 1);
			AssertThatXmlIn.String(page5Data).HasSpecifiedNumberOfMatchesForXpath("//xhtml:img[@aria-describedby]", _ns, 0);
		}
	}
