...
namespace BloomTests.Publish
{
	public class AudioProcessorTests
	{
		...
		public void AudioProcessorGetTrueForAllAudioElements_MixedSpansWithIds_OnlyAudioSpansAreProcessed()
		{
			...
			bool result = SIL.Reflection.ReflectionHelper.GetBoolResult(typeof(AudioProcessor), "IsTrueForAllAudioSentenceElements", new object[] { "bookFolderPath", dom.RawDom, failOnInvalidInputPredicate });
		...
		public void AudioProcessorGetTrueForAllAudioElements_AudioSpansAndDivs_CheckAudioDivsAreProcessedToo()
		{
			...
			bool result = SIL.Reflection.ReflectionHelper.GetBoolResult(typeof(AudioProcessor), "IsTrueForAllAudioSentenceElements", new object[] { "bookFolderPath", dom.RawDom, failIfSearchTargetFound });
