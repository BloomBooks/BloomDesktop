...
<body>
	<div id='bloomDataDiv'>
        ...
        public void RemoveUnwantedLanguageDataFromAllTitles_RemovesUnwantedTitles()
        {
            ...
            string result = PublishModel.RemoveUnwantedLanguageDataFromAllTitles(
                allTitles,
                new[] { "en", "fr", "tpi" }
            );
        ...
        )
        {
            ...
            PublishModel.RemoveUnwantedLanguageData(
                ...
                new[] { "en" },
                true,
                new HashSet<string>(new[] { metadataLang1Code })
            );
        ...
        private void VerifyDataDivValues(HtmlDom dom)
        {
            ...
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='*' and @data-book='contentLanguage1']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='*' and @data-book='contentLanguage2']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='*' and @data-book='contentLanguage3']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='en' and @data-book='bookTitle']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='fr' and @data-book='bookTitle']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='*' and @data-book='coverImage']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='*' and @data-book='coverImageDescription']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='de' and contains(@class,'ImageDescriptionEdit-style')]",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='en' and contains(@class,'ImageDescriptionEdit-style')]",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='es' and contains(@class,'ImageDescriptionEdit-style')]",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='fr' and contains(@class,'ImageDescriptionEdit-style')]",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='tl' and contains(@class,'ImageDescriptionEdit-style')]",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='z' and contains(@class,'ImageDescriptionEdit-style')]",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='en' and @data-book='smallCoverCredits']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='fr' and @data-book='originalContributions']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='de' and @data-book='originalContributions']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='fr' and @data-book='funding']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='de' and @data-book='funding']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='fr' and @data-book='versionAcknowledgments']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='fr' and @data-book='originalAcknowledgments']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='fr' and @data-book='outsideBackCover']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='*' and @data-book='copyright']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='*' and @data-book='licenseUrl']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='en' and @data-book='licenseDescription']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='*' and @data-book='licenseImage']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='fr' and @data-book='insideFontCover']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='fr' and @data-book='insideBackCover']",
                1
            );
            ...
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang and contains(@class,'ImageDescriptionEdit-style')]",
                6
            );
        }

        string kFrontCoverHtml =
            @"<!DOCTYPE html>
<html>
<body>
	<div class='bloom-page cover coverColor bloom-frontMatter frontCover outsideFrontCover side-right A4Landscape' data-page='required singleton' data-export='front-matter-cover' data-xmatter-page='frontCover' id='f9b3d571-ea2d-4c67-9a4e-137a718c90d1' data-page-number=''>
			...
			<div class='bottomBlock'>
				...
				<div class='bottomTextContent'>
					...
					<div class='bottomRow' data-have-topic='false'>
                        ...
                        <div class='coverBottomBookTopic bloom-alwaysShowBubble Cover-Default-style' data-derived='topic' data-functiononhintclick='ShowTopicChooser()' data-hint='Choose topic'></div>
					</div>
				</div>
			</div>
		</div>
        ...
        private void VerifyFrontCoverValues(HtmlDom dom, bool divsRemoved)
        {
            ...
            var assertThatDom = AssertThatXmlIn.Dom(dom.RawDom);
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='en' and contains(@class,'pageLabel')]",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='en' and contains(@class,'pageDescription')]",
                1
            );

            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='z' and contains(@class,'Title-On-Cover-style') and @data-book='bookTitle']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='tl' and contains(@class,'Title-On-Cover-style') and @data-book='bookTitle']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='en' and contains(@class,'Title-On-Cover-style') and @data-book='bookTitle']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='es' and contains(@class,'Title-On-Cover-style') and @data-book='bookTitle']",
                divsExpected
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='fr' and contains(@class,'Title-On-Cover-style') and @data-book='bookTitle']",
                divsExpected
            );
            ...
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='ceb' and contains(@class,'ImageDescriptionEdit-style')]",
                divsExpected
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='es' and contains(@class,'ImageDescriptionEdit-style')]",
            ...
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='*' and @data-book='cover-branding-left-html']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='en' and contains(@class,'smallCoverCredits') and @data-book='smallCoverCredits']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='z' and contains(@class,'smallCoverCredits') and @data-book='smallCoverCredits']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='en' and contains(@class,'coverBottomLangName') and @data-derived='languagesOfBook']",
                1
            );
...
<body>
	<div class='bloom-page bloom-frontMatter credits' data-xmatter-page='credits' id='2cea9462-98e9-4077-be4e-d303a45e95b3' lang=''>
        ...
        private void VerifyCreditsPageValues(HtmlDom dom, bool divsRemoved)
        {
            ...
            var assertThatDom = AssertThatXmlIn.Dom(dom.RawDom);
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='' and contains(@class, 'bloom-page')]",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='en' and @class='pageLabel']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='en' and @class='pageDescription']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='en' and contains(@class, 'licenseAndCopyrightBlock')]",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='*' and contains(@class, 'copyright')]",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='*' and @class='licenseUrl']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='en' and contains(@class, 'licenseDescription')]",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='en' and @data-book='versionAcknowledgments']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='fr' and @data-book='versionAcknowledgments']",
            ...
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='es' and @data-book='versionAcknowledgments']",
                divsExpected
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='en' and @data-book='originalAcknowledgments']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='es' and @data-book='originalAcknowledgments']",
                divsExpected
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='fr' and @data-book='originalAcknowledgments']",
            ...
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='z' and @data-book='originalAcknowledgments']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='en' and @data-book='ISBN']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='es' and @data-book='ISBN']",
                divsExpected
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='fr' and @data-book='ISBN']",
                divsExpected
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='*' and @data-book='ISBN']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='*' and @data-book='credits-page-branding-bottom-html']",
                1
            );
...
<body>
	<div class='bloom-page numberedPage customPage side-right A4Landscape bloom-monolingual' data-page='' id='ba82b94f-71ec-48f7-a1cc-a68d5765e255' data-page-number='2' testRemoves='false' lang=''>
		...
		<div class='marginBox'>
            ...
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='en' and contains(@class, 'bloom-editable') and @role='textbox']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='tl' and contains(@class, 'bloom-editable') and @role='textbox']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='ceb' and contains(@class, 'bloom-editable') and @role='textbox']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='z' and contains(@class, 'bloom-editable') and @contenteditable='true']",
                1
            );

            assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang]", 7);
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang and @testRemoves='false']",
                5
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang and @testRemoves='true']",
                2
            );
...
<body>
	<div class='bloom-page numberedPage customPage side-right A4Landscape bloom-monolingual' data-page='' id='ba82b94f-71ec-48f7-a1cc-a68d5765e255' data-page-number='2' testRemoves='false' lang=''>
		...
		<div class='marginBox'>
            ...
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='en' and contains(@class, 'bloom-editable')]",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
...
<body>
	<div class='bloom-page numberedPage customPage side-right A4Landscape bloom-monolingual' data-page='' id='ba82b94f-71ec-48f7-a1cc-a68d5765e255' testRemoves='false' lang=''>
        ...
        string kEmbeddedLangDivsXMatterHtml =
            @"<!DOCTYPE html>
<html>
<body>
	<div class='bloom-page cover frontCover A4Landscape bloom-monolingual' data-page='required singleton'  data-xmatter-page='frontCover' id='ba82b94f-71ec-48f7-a1cc-a68d5765e255' testRemoves='false' lang=''>
        ...
        private void VerifyOriginalEmbeddedDivsAreAllThere(HtmlDom dom)
        {
            ...
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='de' and contains(@class, 'bloom-translationGroup')]",
                1
            ); // bogus value for test
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='en' and contains(@class, 'bloom-editable') and @role='textbox']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='de' and contains(@class, 'bloom-editable') and @role='textbox']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='es' and contains(@class, 'bloom-editable') and @role='textbox']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='fr' and contains(@class, 'bloom-editable') and @role='textbox']",
                1
            );
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@lang='z' and contains(@class, 'bloom-editable') and @contenteditable='true']",
        ...
        private void VerifyOnlyUnwantedEmbeddedDivsAreRemoved(HtmlDom dom, bool isXMatterWithN1)
        {
            ...
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@testRemoves='false']", 4);
            assertThatDom.HasSpecifiedNumberOfMatchesForXpath(
                "//div[@testRemoves='true']",
                countOfGerman
            );
        }

        string kCssStylesHtml =
            @"<!DOCTYPE html>
<html>
<head>
...
<body>
	<div class='bloom-page bloom-frontMatter credits' data-xmatter-page='credits' id='2cea9462-98e9-4077-be4e-d303a45e95b3' lang=''>
        ...
        public void RemoveUnwantedLanguageData_PreserveCssStylesForN1(
        ...
        )
        {
            ...
            PublishModel.RemoveUnwantedLanguageData(
                ...
                languagesToInclude,
                shouldPruneXmatter,
                new HashSet<string>(new[] { "es", "xkal" })
            );
