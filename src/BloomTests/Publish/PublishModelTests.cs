...
<body>
	<div id='bloomDataDiv'>
		...
		<div data-book='licenseImage' lang='*'>license.png</div>
			...
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='tl']", 1);	// lost picture description
			assertThatDom.HasNoMatchForXpath("//div[@lang='ceb']");						// lost picture description
...
<body>
	<div id='bloomDataDiv'>
		...
		<div data-book='insideBackCover' lang='fr'>
			...
			// Check counts in modified HTML.
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='de']", 2);	// lost picture description
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='en']", 4);	// unchanged
			assertThatDom.HasNoMatchForXpath("//div[@lang='es']");						// lost picture description
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='fr']", 8);	// lost picture description
			assertThatDom.HasNoMatchForXpath("//div[@lang='tl']");						// lost picture description
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='z']", 1);	// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='*']", 8);	// unchanged
