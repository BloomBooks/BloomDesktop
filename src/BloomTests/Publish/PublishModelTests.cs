...
namespace BloomTests.Publish
{
	...
	{
		[Test]
		public void RemoveUnwantedLanguageData_BloomDataDiv_PreserveDataBookDivs()
		{
...
<body>
	<div id='bloomDataDiv'>
		...
		<div data-book='insideBackCover' lang='fr'><p>Ceci est à l'intérieur de la couverture arrière.</p></div>
			...
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang]", 20);
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@data-book]", 20);

			// SUT
			PublishModel.RemoveUnwantedLanguageData(dom, new[] {"en"});

			// Check occurrences in modified HTML.
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='de' and @data-book='originalContributions']", 1);	// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='de' and @data-book='funding']", 1);				// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='en' and @data-book='bookTitle']", 1);			// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='en' and @data-book='smallCoverCredits']", 1);	// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='en' and @data-book='licenseDescription']", 1);	// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='fr' and @data-book='bookTitle']", 1);			// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='fr' and @data-book='originalContributions']", 1);	// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='fr' and @data-book='funding']", 1);				// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='fr' and @data-book='versionAcknowledgments']", 1);	// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='fr' and @data-book='originalAcknowledgments']", 1);	// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='fr' and @data-book='outsideBackCover']", 1);		// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='fr' and @data-book='insideFontCover']", 1);		// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='fr' and @data-book='insideBackCover']", 1);		// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='*' and @data-book='contentLanguage1']", 1);		// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='*' and @data-book='contentLanguage2']", 1);		// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='*' and @data-book='contentLanguage3']", 1);		// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='*' and @data-book='coverImage']", 1);			// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='*' and @data-book='copyright']", 1);			// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='*' and @data-book='licenseUrl']", 1);			// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='*' and @data-book='licenseImage']", 1);			// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang]", 20);			// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@data-book]", 20);		// unchanged
		}

		[Test]
		public void RemoveUnwantedLanguageData_BloomDataDiv_RemoveUnwantedImageDescriptions()
		{
			var html = @"<!DOCTYPE html>
<html>
<body>
	<div id='bloomDataDiv'>
		<div data-book='coverImageDescription' lang='*'>
			...
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@data-book]", 1);

			// SUT
			PublishModel.RemoveUnwantedLanguageData(dom, new[] {"en", "fr"});

			// Check occurrences in modified HTML.
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='*' and @data-book='coverImageDescription']", 1);		// unchanged
			assertThatDom.HasNoMatchForXpath("//div[@lang='de' and contains(@class,'ImageDescriptionEdit-style')]");				// removed image description
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='en' and contains(@class,'ImageDescriptionEdit-style')]", 1);	// unchanged
			assertThatDom.HasNoMatchForXpath("//div[@lang='es' and contains(@class,'ImageDescriptionEdit-style')]");				// removed image description
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='fr' and contains(@class,'ImageDescriptionEdit-style')]", 1);	// unchanged
			assertThatDom.HasNoMatchForXpath("//div[@lang='tl' and contains(@class,'ImageDescriptionEdit-style')]");				// removed image description
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='z' and contains(@class,'ImageDescriptionEdit-style')]", 1);	// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang]", 4);		// removed 3 image descriptions
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@data-book]", 1);	// unchanged
		}

		[Test]
		public void RemoveUnwantedLanguageData_FrontCoverPage_RemovesOnlyImageDescriptions()
		{
			var html = @"<!DOCTYPE html>
<html>
<body>
	<div class='bloom-page cover coverColor bloom-frontMatter frontCover outsideFrontCover side-right A4Landscape' data-page='required singleton' data-export='front-matter-cover' data-xmatter-page='frontCover' id='f9b3d571-ea2d-4c67-9a4e-137a718c90d1' data-page-number=''>
		...
		<div class='marginBox'>
			...
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='en' and contains(@class,'ImageDescriptionEdit-style') and @role='textbox']", 1);
			...
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='tl' and contains(@class,'ImageDescriptionEdit-style') and @role='textbox']", 1);
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='ceb' and contains(@class,'ImageDescriptionEdit-style') and @role='textbox']", 1);
			...
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='z' and contains(@class,'ImageDescriptionEdit-style') and @contenteditable='true']", 1);
			...
			// Check occurrences in modified HTML.
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='en' and contains(@class,'pageLabel')]", 1);				// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='en' and contains(@class,'pageDescription')]", 1);		// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='en' and contains(@class,'Title-On-Cover-style') and @data-book='bookTitle']", 1);		// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='en' and contains(@class,'ImageDescriptionEdit-style') and @role='textbox']", 1);		// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='en' and contains(@class,'smallCoverCredits') and @data-book='smallCoverCredits']", 1);	// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='tl' and contains(@class,'Title-On-Cover-style') and @data-book='bookTitle']", 1);		// unchanged
			assertThatDom.HasNoMatchForXpath("//div[@lang='tl' and contains(@class,'ImageDescriptionEdit-style') and @role='textbox']");	// removed image description
			assertThatDom.HasNoMatchForXpath("//div[@lang='ceb' and contains(@class,'ImageDescriptionEdit-style') and @role='textbox']");	// removed image description
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='z' and contains(@class,'Title-On-Cover-style') and @data-book='bookTitle']", 1);		// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='z' and contains(@class,'ImageDescriptionEdit-style') and @contenteditable='true']", 1);	// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='z' and contains(@class,'smallCoverCredits') and @data-book='smallCoverCredits']", 1);	// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='*' and @data-book='cover-branding-left-html']", 1);		// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang]", 10);		// removed 2 imaged descriptions
		}
		[Test]
		public void RemoveUnwantedLanguageData_CreditsPage_PreservesEverything()
		{
			var html = @"<!DOCTYPE html>
<html>
<body>
	<div class='bloom-page bloom-frontMatter credits' data-xmatter-page='credits' id='2cea9462-98e9-4077-be4e-d303a45e95b3' lang=''>
		...
		<div class='bloom-translationGroup versionAcknowledgments' data-default-languages='N1'>
			<div data-languagetipcontent='English' style='' class='bloom-editable versionAcknowledgments Credits-Page-style bloom-content1' data-book='versionAcknowledgments' lang='en' contenteditable='true'></div>
		...
		<div data-book='credits-page-branding-bottom-html' lang='*'><img class='branding' src='butterfly.png' alt=''></img></div>
			...
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='en' and contains(@class, 'licenseAndCopyrightBlock')]", 1);	// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='en' and contains(@class, 'licenseDescription')]", 1);	// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='en' and @data-book='versionAcknowledgments']", 1);	// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='en' and @data-book='originalAcknowledgments']", 1);	// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='en' and @data-book='ISBN']", 1);			// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='es' and @data-book='versionAcknowledgments']", 1);	// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='es' and @data-book='originalAcknowledgments']", 1);	// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='es' and @data-book='ISBN']", 1);			// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='fr' and @data-book='versionAcknowledgments']", 1);	// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='fr' and @data-book='originalAcknowledgments']", 1);	// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='fr' and @data-book='ISBN']", 1);			// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='z' and @data-book='originalAcknowledgments']", 1);	// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='*' and contains(@class, 'copyright')]", 1);	// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='*' and @class='licenseUrl']", 1);			// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='*' and @data-book='ISBN']", 1);				// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='*' and @data-book='credits-page-branding-bottom-html']", 1);	// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='' and contains(@class, 'bloom-page')]", 1);	// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang]", 19);	// unchanged
		}
...
<body>
	<div class='bloom-page numberedPage customPage side-right A4Landscape bloom-monolingual' data-page='' id='ba82b94f-71ec-48f7-a1cc-a68d5765e255' data-pagelineage='a31c38d8-c1cb-4eb9-951b-d2840f6a8bdb;b0503546-bdb5-4e85-a77c-3f8d5ab43397;94f328c2-a113-4d75-8551-ccb19f1de268' data-page-number='2' lang=''>
		...
		<div class='marginBox'>
			...
			assertThatDom.HasNoMatchForXpath("//div[@lang='en' and contains(@class, 'bloom-editable') and @role='textbox']");		// removed editable textbox
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='tl' and contains(@class, 'bloom-editable') and @role='textbox']", 1);	// unchanged
			assertThatDom.HasNoMatchForXpath("//div[@lang='ceb' and contains(@class, 'bloom-editable') and @role='textbox']");		// removed editable textbox
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='z' and contains(@class, 'bloom-editable') and @contenteditable='true']", 1);	// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang]", 5);	// removed 2 editable textboxes
		}
		...
		[Test]
		public void RemoveUnwantedLanguageData_PreservesIfWantEmbeddedDiv()
		{
			var html = @"<!DOCTYPE html>
<html>
<body>
	<div class='bloom-page numberedPage customPage side-right A4Landscape bloom-monolingual' data-page='' id='ba82b94f-71ec-48f7-a1cc-a68d5765e255' lang='de'>
		<div class='pageLabel' data-i18n='TemplateBooks.PageLabel.Just Text' lang='en'>Just Text</div>
		<div class='pageDescription' lang='en'></div>
		<div class='marginBox'>
			<div class='split-pane-component-inner'>
				<div class='bloom-translationGroup bloom-trailingElement' data-default-languages='auto'>
					<div data-languagetipcontent='English' role='textbox' class='bloom-editable normal-style bloom-content1 bloom-visibility-code-on' contenteditable='true' lang='en'><p>Hello</p></div>
					<div class='bloom-editable normal-style' contenteditable='true' lang='z'></div>
				</div>
			</div>
		</div>
			...
			var dom = new HtmlDom(html);
			var assertThatDom = AssertThatXmlIn.Dom(dom.RawDom);
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='de' and contains(@class, 'bloom-page')]", 1);	// bogus value for test...
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='en' and @class='pageLabel']", 1);
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='en' and @class='pageDescription']", 1);
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='en' and contains(@class, 'bloom-editable') and @role='textbox']", 1);
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='z' and contains(@class, 'bloom-editable') and @contenteditable='true']", 1);
			...
			// Check occurrences in modified HTML.
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='de' and contains(@class, 'bloom-page')]", 1);	// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='en' and @class='pageLabel']", 1);			// unchanged despite lang='en'
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='en' and @class='pageDescription']", 1);		// unchanged despite lang='en'
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='en' and contains(@class, 'bloom-editable') and @role='textbox']", 1);	// unchanged
			assertThatDom.HasSpecifiedNumberOfMatchesForXpath("//div[@lang='z' and contains(@class, 'bloom-editable') and @contenteditable='true']", 1);	// unchanged
