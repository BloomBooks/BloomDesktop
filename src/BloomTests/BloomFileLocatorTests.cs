    ...
    public class BloomFileLocatorTests
    {
        ...
        public void Setup()
        {
            ...
            RobustFile.WriteAllText(
                Path.Combine(_xMatterFolder.Path, "SomeRandomXYZABCStyles.css"),
                "Some arbitrary test data"
            );
            RobustFile.WriteAllText(
                Path.Combine(_xMatterFolder.Path, "Decodable Reader.css"),
                "Fake DR test data"
            );
        ...
        public void BloomBrowserUIIsPrefferedOverFactorXMatter()
        {
            ...
            Assert.That(
                ...
                Does.Contain(BloomFileLocator.BrowserRoot.Replace("\\", "/"))
            );
        }
