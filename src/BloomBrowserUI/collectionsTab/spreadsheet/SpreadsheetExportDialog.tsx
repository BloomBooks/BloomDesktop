...
import { useSetupBloomDialogFromServer } from "../../react_components/BloomDialog/BloomDialogPlumbing";
...
export const SpreadsheetExportDialog: React.FunctionComponent<{}> = () => {
    const {
        ...
        closeDialog,
        propsForBloomDialog
    } = useSetupBloomDialogFromServer("SpreadsheetExportDialog");
...
export const SpreadsheetExportDialogInner: React.FunctionComponent<{
    closeDialog: () => void;
