...
import FolderIcon from "@mui/icons-material/FolderDelete";
            ...
            {props.isLink ? (
                ...
                >
                    ...
                    <div
                        css={css`
                            margin-left: 30px;
                            margin-bottom: -5px; // prevent wiggle when appearing/disappearing
                            display: none;
                            color: ${kBloomBlue};
                    ...
                    >
                        <BloomTooltip
                            id="DoNotShowCollection"
                            tooltipBackColor={kBloomBlue}
                            side="bottom" // we may want "right", but that's not implemented
                            tooltipContent={
                                <Div
                                    l10nKey="CollectionTab.DoNotShowCollection"
                                    css={css`
                                        max-width: 200px;
                                    `}
                                >
                ...
                >
                    ...
                    <div
                        ...
                        `}
                        onClick={() => props.onRemoveSourceFolder(props.id)}
                    >
                        <BloomTooltip
                            id="RemoveThisGroup"
                            tooltipBackColor={kBloomBlue}
                            ...
                            tooltipContent={
                                <Div
                                    l10nKey="CollectionTab.RemoveThisGroup"
                                    css={css`
                                        max-width: 200px;
                                    `}
                                >
                                    delete the folder. Click here to view the
