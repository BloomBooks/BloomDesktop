Note: The Overlay Tool requires that you have [Bloom Enterprise](/bloom/api/common/showSettingsDialog?tab=enterprise) enabled. However, you can localize a shellbook that contain overlay elements into your own language without enabling Bloom Enterprise.
