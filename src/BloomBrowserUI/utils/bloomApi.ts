...
export class BloomApi {
    ...
    public static getP(urlSuffix: string, config: AxiosRequestConfig, successCallback: (r: AxiosResponse) => void) {
    ...
    public static postD(urlSuffix: string, data: any, successCallback?: (r: AxiosResponse) => void) {
        if (successCallback) {
    ...
    public static postP(urlSuffix: string, data: any, config: AxiosRequestConfig, successCallback?: (r: AxiosResponse) => void) {
        if (successCallback) {
