...
export default class WebSocketManager {
    ...
    // (If this throws some exception, it will be reported as usual, and we will continue
    // to attempt reconnection of any sockets that need it at regular intervals.)
    ...
    private static continuouslyCheckForClosedSockets() {
        ...
        const looper = () => {
            ...
            // (toast with option to report, maybe only in Alpha/Debug builds?). But hopefully it's
            ...
            // Of course, if it throws every time, that will get annoying. But if there's some
