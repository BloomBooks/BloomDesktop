...
export class MeasureText {
    ...
    public static getDescentMeasurements(
        ...
        const fontDescent = outerRect.bottom - innerRect.bottom;

        div.style.lineHeight = lineHeight;
        const outerRect2 = div.getBoundingClientRect();
        const innerRect2 = block.getBoundingClientRect();
        const layoutDescent = outerRect2.bottom - innerRect2.bottom;
