...
export class MeasureText {
    ...
    public static getDescentMeasurements(
        ...
        if (!div) {
            ...
            div.style.pointerEvents = "none"; // not sure this is necessary but won't hurt
            // If we append it to the document without this, it takes up space, which can cause spurious scroll bars to appear
