...
// Standalone build for the Edit Tab (editViewFrame) bundle only.
// Usage: yarn vite build --config vite.editTab.config.ts
export default defineConfig(() => {
    const entry = "./bookEdit/editViewFrame.ts";
...
`;
    ...
    return {
        ...
        build: {
            ...
            manifest: false,
            rollupOptions: {
                input: { editTabBundle: entry },
                output: {
                    entryFileNames: "editTabBundle.js",
                    chunkFileNames: "editTabBundle-[name].js",
