    ...
    module htmlParser {
        ...
        class filter {
            ...
            addRules(
                ...
                options?: { priority?: number; applyToAll?: boolean }
            ): void;
        ...
        class fragment {
            ...
            forEach(
                callback: (node: node, type?: number) => boolean,
                type?: number,
                skipRoot?: boolean
            ): void;
        }
