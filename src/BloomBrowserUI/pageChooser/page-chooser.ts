...
import "errorHandler";
import TemplatePagePreview from "../react_components/templatePagePreview";
...
export class PageChooser {
    ...
    public static addPageClickHandler(
        ...
        if (forChangeLayout) {
            const convertAnywayCheckboxElement = document.getElementById(
                "convertAnywayCheckbox"
            ) as HTMLInputElement;
            if (
                !convertAnywayCheckboxElement ||
                !convertAnywayCheckboxElement.checked
            ) {
                return;
            }
            const wholeBookCheckboxElement = document.getElementById(
            ...
            BloomApi.postData(
                "changeLayout",
                {
                    ...
                    convertWholeBook: wholeBookCheckboxElement
                        ? wholeBookCheckboxElement.checked
                        : false
                },
                PageChooser.closeup
            );
...
export function addPageClickHandler(
    ...
    PageChooser.addPageClickHandler(forChangeLayout, pageId, templateBookPath);
}
...
// Copied from react_components/requiresBloomEnterprise.
// If/when this becomes a React component that will no longer be necessary.
