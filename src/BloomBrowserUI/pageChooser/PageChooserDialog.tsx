...
export const PageChooserDialog: React.FunctionComponent<IPageChooserdialogProps> = props => {
    ...
    //   1) If ChooserPageGroup goes to find a template page .svg file, and there isn't one for a
    ...
    const thumbnailUpdatedListener = useCallback(
        e => {
            ...
            const src = (e as any).src as string;
    ...
    // It doesn't work to put this scrolling-on-selection mechanism in ChooserPageGroup, because we need
