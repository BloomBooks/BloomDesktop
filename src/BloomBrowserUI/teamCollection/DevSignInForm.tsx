...
// The dev-auth-mode email/password sign-in form shared by the dedicated sign-in dialog
...
// state + submit/validation logic the two hosts also shared lives in useDevSignIn() below.

export const DevSignInForm: React.FunctionComponent<{
...
// Container-side half of the shared dev sign-in flow: owns the email/password/submit-attempt/
...
// into DevSignInForm's props (usually via a presentational Body component in between).
