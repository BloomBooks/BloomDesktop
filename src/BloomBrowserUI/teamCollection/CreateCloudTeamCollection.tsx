            ...
            <div data-testid="cloud-create-signin-step">
                ...
                {props.loginState.mode === "dev" ? (
                    <DevSignInForm
                        ...
                        password={props.devPassword}
                        onEmailChange={props.onDevEmailChange}
                        onPasswordChange={props.onDevPasswordChange}
                        onSignIn={props.onDevSignIn}
        ...
        <BloomDialog {...propsForBloomDialog}>
            ...
            <DialogMiddle>
                <CreateCloudTeamCollectionBody
                    ...
                    devEmail={devSignIn.email}
                    devPassword={devSignIn.password}
                    onDevEmailChange={devSignIn.setEmail}
                    onDevPasswordChange={devSignIn.setPassword}
                    onDevSignIn={devSignIn.onSignIn}
                    signInSubmitAttempts={devSignIn.submitAttempts}
