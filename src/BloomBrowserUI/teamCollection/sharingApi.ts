...
// Matches CONTRACTS.md: in local-auth mode, sign-in is a plain email/password form; in "cloud"
...
export type SharingLoginMode = "local" | "cloud";
...
// Posts local-auth-mode credentials. Resolves once the server has updated the login state;
...
// exactly as the "local" mode signIn() callers already do.
