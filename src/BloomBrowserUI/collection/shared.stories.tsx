...
// This file is not a story itself, but provides shared helpers for collection story files.
export default {};
...
export const sampleCollections = [
    ...
    {
        title: "Collection 2 Collection 2 Collection 2 Collection 2 Collection 2",
        bookCount: 0,
        path: "C:/Collections/Collection2",
    },
    {
        title: "Collection 3 with a long title with a long title with a a long title",
        isTeamCollection: true,
        bookCount: 30,
        checkedOutCount: 1,
