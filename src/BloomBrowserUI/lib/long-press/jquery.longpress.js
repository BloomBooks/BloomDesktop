...
(function ($, window, undefined) {
    ...
    const longpressEvaluationAttr = 'data-longpress-evaluation-in-progress';
    ...
    function onKeyDown(e) {
        ...
        $(activeElement).attr(longpressEvaluationAttr, 'true');
    ...
    function onKeyUp(e) {
        try {
            ...
            $(activeElement).removeAttr(longpressEvaluationAttr);
        }
    }
    function onTimer() {
