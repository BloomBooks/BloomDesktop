...
(function(window, document, undefined) {
    ...
    (function(factory) {
            ...
            var invalid = function(a) {
                ...
                invalidContent = function(c) {
                    return (
                        ...
                        ((!c && !c.attr) ||
                            c.length < 1 ||
                            ("object" === typeof c && !c.jquery && !c.then))
                    );
                };
        ...
        function QTip(target, options, id, attr) {
            ...
            function createButton() {
                ...
                if (button.jquery) {
                    ...
                    elements.button = $("<a />", {
                        class:
                            "qtip-close " +
                            (options.style.widget ? "" : NAMESPACE + "-icon"),
                        title: close,
                        "aria-label": close
                    }).prepend(
                        $("<span />", {
            ...
            function assignEvents() {
                ...
                function hideMethod(event) {
                    if (
                        tooltip.hasClass(disabledClass) ||
                        isPositioning ||
                        isDrawing
                    ) {
                        return FALSE;
                    ...
                    var relatedTarget = $(event.relatedTarget || event.target),
                        ontoTooltip =
                            relatedTarget.closest(selector)[0] === tooltip[0],
                ...
                $.each(events.hide, function(index, type) {
                    ...
                    if (
                        (showIndex > -1 &&
                            targetHide.add(targets.show).length ===
                                targetHide.length) ||
                        type === "unfocus"
                    ) {
                ...
                if (posOptions.target === "mouse") {
                    ...
                    if (posOptions.adjust.mouse) {
                        ...
                        if (options.hide.event) {
                            ...
                            tooltip.bind("mouseleave" + namespace, function(
                                event
                            ) {
                                if (
            ...
            $.extend(self, {
                ...
                reposition: function(event, effect) {
                    ...
                    // Target wasn't mouse or absolute...
                        ...
                        // Use Imagemap/SVG plugins if needed
                            ...
                            var scaleY =
                                bounds.height / targetElem.offsetHeight;
                ...
                disable: function(state) {
                    if ("boolean" !== typeof state) {
                        state = !(
                            tooltip.hasClass(disabledClass) || cache.disabled
                        );
                    }
                ...
                if (parent) {
                    ...
                    do {
                        if (parent.css("position") !== "static") {
                            ...
                            pos.left -=
                                coffset.left +
                                (parseInt(parent.css("borderLeftWidth"), 10) ||
                                    0) +
                                (parseInt(parent.css("marginLeft"), 10) || 0);
                            pos.top -=
                                coffset.top +
                                (parseInt(parent.css("borderTopWidth"), 10) ||
                                    0) +
        ...
        $.each(PLUGINS.fn, function(name, func) {
            ...
            $.fn[name] = function() {
                return (
                    func.apply(this, arguments) || old.apply(this, arguments)
                );
            };
        });
        ...
        function Tip(qTip, command) {
            ...
            function parseRadius(corner) {
                var isTitleTop = elems.titlebar && corner.y === TOP,
                    ...
                    standard =
                        "border-" + corner.y + "-" + corner.x + "-radius",
                    css = function(c) {
                        return (
                            parseInt(elem.css(c), 10) ||
            ...
            function parseColours(actual) {
                var i,
                    ...
                    borderSide =
                        "border-" + corner[corner.precedance] + "-color",
            ...
            $.extend(self, {
                ...
                create: function() {
                    ...
                    if (hasCanvas) {
                        ...
                        $("*", elems.tip).bind("click mousedown", function(
                            event
                        ) {
                ...
                update: function(corner, position) {
                    ...
                    if (hasCanvas) {
                        ...
                        if (border) {
                            ...
                            if (
                                tooltip.css("background-clip") === "border-box"
                            ) {
                    ...
                    // VML (IE Proprietary implementation)
                        ...
                        translate[2] =
                            border && /^(r|b)/i.test(corner.string())
                                ? parseFloat($.browser.version, 10) === 8
                                    ? 2
                                    : 1
                                : 0;
            ...
            $.extend(self, {
                init: function() {
                    ...
                    tooltip
                            ...
                            function(event, api, duration) {
                                ...
                                if (event.target === tooltip[0]) {
                                    if (
                                        ...
                                        /mouse(leave|enter)/.test(
                                            oEvent.type
                                        ) &&
                                        $(oEvent.relatedTarget).closest(
                                            overlay[0]
                                        ).length
                                    ) {
                                        try {
                        ...
                        .bind("tooltipfocus" + globalNamespace, function(
                            event
                        ) {
                ...
                create: function() {
                    ...
                    if (elem.length) {
                        ...
                        return (elems.overlay = elem.insertAfter(
                            $(selector).last()
                        ));
                    }
                    ...
                    win.unbind(globalNamespace).bind(
                        "resize" + globalNamespace,
                        resize
                    );
                ...
                toggle: function(event, state, duration) {
                    ...
                    if (
                        (overlay.is(":animated") &&
                            visible === state &&
                            overlay.data("toggleState") !== FALSE) ||
                        (!state && modals.length)
                    ) {
                        return self;
                    }
        ...
        PLUGINS.viewport = function(
            ...
            if (
                newMy &&
                cache.lastClass !==
                    (newClass = NAMESPACE + "-pos-" + newMy.abbrev())
            ) {
                tooltip
        ...
        function IE6(api) {
            ...
            $.extend(self, {
                ...
                adjustBGIFrame: function() {
                    ...
                    offset =
                        parseInt(tooltip.css("border-left-width"), 10) || 0;
