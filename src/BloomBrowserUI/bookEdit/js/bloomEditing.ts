...
export function SetupElements(container) {
    ...
    // For getting focus set reliably, it seems best to do the whole loop inside one delay, rather than have separate delays
    // inside the method called each time through the loop.
    setTimeout(() => {
