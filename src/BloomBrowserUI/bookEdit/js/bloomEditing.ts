...
function AddEditKeyHandlers(container) {
    ...
    $(document).bind("keydown", "ctrl+u", function(e) {
        e.preventDefault();
        document.execCommand("underline", undefined, null);
    });
    $(document).bind("keydown", "ctrl+b", function(e) {
        e.preventDefault();
        document.execCommand("bold", undefined, null);
    });
    $(document).bind("keydown", "ctrl+i", function(e) {
        e.preventDefault();
        document.execCommand("italic", undefined, null);
    });
...
function SetBookCopyrightAndLicenseButtonVisibility(container) {
    var shouldShowButton = !$(container)
        .find("DIV.copyright")
        .text();
    $(container)
...
function SetupElements(container) {
    ...
    var divsThatHaveSourceBubbles: any[] = [];
    var bubbleDivs: any[] = [];
