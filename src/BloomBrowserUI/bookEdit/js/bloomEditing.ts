            ...
            if (elementToFocus && focusable) {
                ...
                if (emptyEditables.length) {
                    ...
                    if (emptyTextBlockOverlay) {
                        // We want to focus on the first empty overlay text with style "none".  Since a text
                        // box in an overlay can't be in an image description, we don't need to check that.
