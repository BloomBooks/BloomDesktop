...
// focused element that allows the ctrl-V handler to be called. Because it is
// capture:true, it works even in places where otherwise a different paste handler
// would ignore pasting an image.
