...
export class BubbleManager {
    ...
    private focusFirstVisibleElement(activeElement: HTMLElement) {
    ...
    public turnOnBubbleEditing(): void {
        ...
        Comical.setActiveBubbleListener(activeElement => {
            if (activeElement) {
                this.focusFirstVisibleElement(activeElement);
            }
        });
        ...
        if (textOverPictureElems.length > 0) {
            ...
            this.focusFirstVisibleElement(this.activeElement);
            ...
            if (marginBox.length > 0) {
                this.focusFirstVisibleElement(marginBox[0] as HTMLElement);
            }
        }
