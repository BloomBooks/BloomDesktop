    ...
    private continueTextBoxResize(event: MouseEvent, editable: HTMLElement) {
        ...
        switch (this.currentDragSide) {
            case "e":
                ...
                // This won't adjust the height of the editable, but it will
                // mark overflow appropriately.
                theOneBubbleManager.adjustBubbleHeightToContentOrMarkOverflow(
                    editable
                );
                break;
            case "w":
            ...
            case "s":
                ...
                // This won't adjust the height of the editable, but it will
                // mark overflow appropriately.  See BL-13902.
                theOneBubbleManager.adjustBubbleHeightToContentOrMarkOverflow(
                    editable
                );
                break;
