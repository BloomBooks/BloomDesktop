...
export class BubbleManager {
    ...
    public refreshBubbleEditing(
        ...
        if (bubble) {
            ...
            this.updateOverlayClass(imageContainer);
    ...
    public updateOverlayClass(imageContainer: HTMLElement) {
        if (
...
export function updateOverlayClass(imageContainer: HTMLElement) {
    initializeBubbleManager(); // If already initialized, this is harmless.
    theOneBubbleManager.updateOverlayClass(imageContainer);
}
