...
function SetupVideoContainer(containerDiv: Element) {
    ...
    let containerDivs = $(containerDiv);
    containerDivs.mouseenter(function () {
        var $this = $(this);
    ...
    containerDivs.each((idx, div: HTMLDivElement) => {
        if (div.classList.contains("bloom-noVideoSelected")) {
            $(div).click(function () {
