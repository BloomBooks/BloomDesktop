...
import { importVideoAndShowProgressDialog as doImportVideoAndShowProgress } from "./ImportVideoProgressDialogLauncher";
...
const importVideoAndShowProgressDialog = (
    onImported: (importedPath?: string) => void,
) => {
    doImportVideoAndShowProgress(onImported, ShowEditViewDialog);
};
