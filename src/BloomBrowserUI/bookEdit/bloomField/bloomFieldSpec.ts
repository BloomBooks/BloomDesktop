...
describe("BloomField", () => {
    ...
    it("removeAudioSpanMarkupDuringPasting removes both .audio-sentence and .bloom-highlightSegment span markup", () => {
        ...
        expect(result4).toBe(
            '<p>Part 1: <span class="bloom-linebreak">God, Creation &amp; Fall, Law</span></p>'
