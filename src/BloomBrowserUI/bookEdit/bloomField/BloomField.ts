...
export default class BloomField {
    ...
    public static WireToCKEditor(
        ...
        ckeditor.on("paste", event => {
            event.data.dataValue = this.reconstitueParagraphsOnPlainTextPaste(
                event.data
            );
    ...
    // Return value will reset 'event.data.dataValue'
    static reconstitueParagraphsOnPlainTextPaste(eventData: any): any {
