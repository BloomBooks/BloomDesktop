...
export default class BloomField {
    public static ManageField(bloomEditableDiv: HTMLElement) {
        ...
        */
        ...
        if (
            !$(bloomEditableDiv).hasClass("bloom-noParagraphs") && // test for possible explicit markup
            (!$(bloomEditableDiv).hasClass("WordFind-style") || // test for Story Primer Wordfind markup
