...
class BloomField {
    ...
    static ManageField(target:HTMLElement) {
    ...
    static PreventArrowingOutIntoField(field:HTMLElement) {
        $(field).keydown(function (e) {
            ...
            if (leftArrowPressed || rightArrowPressed) {
                ...
                if (sel.anchorNode === this) {
                    ...
                    e.preventDefault();
                    BloomField.MoveCursorToFirstParagraph(this, leftArrowPressed ? CursorPosition.start : CursorPosition.end);
                }
            }
        })
    }

    static EnsureStartsWithParagraphElement(field:HTMLElement) {
    ...
    static EnsureEndsWithParagraphElement(field:HTMLElement) {
    ...
    static ConvertTextNodesToParagraphs(field: HTMLElement){
    ...
    static ModifyForParagraphMode(field:HTMLElement) {
    ...
    static RequiresParagraphs(field : HTMLElement) : boolean {
    ...
    static HandleFieldFocus(field:HTMLElement) {

       BloomField.MoveCursorToFirstParagraph(field, CursorPosition.start);
        return;
    ...
    static MoveCursorToFirstParagraph(field: HTMLElement, position: CursorPosition ){
        var range = document.createRange();
    ...
    static ManageWhatHappensIfTheyDeleteEverything(field: HTMLElement) {
        ...
        $(field).on("input", function (e) {
            if ($(this).find('p').length === 0) {
                ...
                BloomField.MoveCursorToFirstParagraph(field, CursorPosition.end);
            }
        });
    }
    ...
    static PreventRemovalOfSomeElements(field:HTMLElement) {
    ...
    static PrepareNonParagraphField(field:HTMLElement) {
        if ($(field).text() === '') {
    ...
    static FixUpOnFirstInput(event: any) {
