...
export default class OverflowChecker {
    ...
    public static getSelfOverflowAmounts(
        ...
        // For canvas elements that are automatically sized, we don't need to worry about
        // getting a font fudge factor.  The canvas element will grow taller (or shorter)
        // to accomodate the text.  We actually prefer a bit of margin at the bottom, so
        // reporting a larger overflow allows the canvas element to grow a bit taller and
        // not look so cramped.  See BL-14770.
