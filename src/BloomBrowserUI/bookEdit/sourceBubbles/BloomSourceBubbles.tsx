...
export default class BloomSourceBubbles {
    ...
    // This could be better done with resizeObserver? But we need it for position, too...FixGecko60.
    // Note, in that case we'd want to observe each .bloom-editable, not the whole page.
