The files in this folder are a subset of the standard download of font-awesome 4.03, from http://fortawesome.github.io/Font-Awesome/, licensed under the SIL Font license.
...
Note that this folder MUST be located within the folder that contains ReaderTools.htm. FireFox 'same origin' rules prevent loading the font otherwise, and you get boxes instead of icons (with no obvious explanation).