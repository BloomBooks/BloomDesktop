...
(function ($) {
    $.widget("bloom.pagesThumbnailList", {
                ...
                $.get(url, null, null, "html")
                    .done(function (pageData) {
                        ...
                        $(pageDivs).each(function (div) {
                            ...
                            $(listTOAddThumbnailsTo).append(
                                $('<li data-w="1" data-h="1">Hello</li>'),
                            );
                        });
                    ...
                    .fail(function (jqXHR, textStatus, errorThrown) {
                        console.log(
                            "There was a problem reading the url. " +
                                jqXHR.status +
                                " " +
                                textStatus +
                                " " +
        ...
        ThumbnailClickHandler: function (div) {
            ...
            $("#previewCaption").text(
                $(".templatePageCaption", this.SelectedPage).text(),
            );
            $("#preview").attr(
                "src",
                $(this.SelectedPage).find("iframe").first().attr("src"),
            );
