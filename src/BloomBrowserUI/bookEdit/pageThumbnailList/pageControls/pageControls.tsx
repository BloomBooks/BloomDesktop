            ...
            <div>
                ...
                <div id="row2">
                    <BloomButton
                        ...
                        enabledImageFile="/bloom/bookEdit/pageThumbnailList/pageControls/duplicatePage.png"
                        disabledImageFile="/bloom/bookEdit/pageThumbnailList/pageControls/duplicatePageDisabled.png"
                        hasText={false}
                    ...
                    <BloomButton
                        ...
                        enabledImageFile="/bloom/bookEdit/pageThumbnailList/pageControls/deletePage.png"
                        disabledImageFile="/bloom/bookEdit/pageThumbnailList/pageControls/deletePageDisabled.png"
                        hasText={false}
                        ...
                        <span>
                            {this.state.lockState === "BookLocked" &&
                                <BloomButton
                                    ...
                                    enabledImageFile="/bloom/bookEdit/pageThumbnailList/pageControls/lockedPage.png"
                                    hasText={false}
                            ...
                            {this.state.lockState === "BookUnlocked" &&
                                <BloomButton
                                    ...
                                    enabledImageFile="/bloom/bookEdit/pageThumbnailList/pageControls/unlockedPage.png"
                                    hasText={false}
