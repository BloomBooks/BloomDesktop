...
- Files in the root folder (this one, toobox) should contain only generic code for managing the toolbox as a whole
- Anything that is part of the implementation of a particular tool should be in one of the child folders, of which there is one for each tab in the accordion.
...
Ideally it should be possible to add a new tab to the accordion without modifying any file outside the new folder
