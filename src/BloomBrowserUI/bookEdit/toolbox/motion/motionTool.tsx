...
export class MotionTool extends ToolboxToolReactAdaptor {
    ...
    public static featureName?: string | undefined = kMotionToolId;
    public featureName?: string | undefined = MotionTool.featureName;
    ...
    public render() {
        return (
            <RequiresSubscriptionOverlayWrapper
                featureName={MotionTool.featureName as string}
            >
                <div
                    className={
                        "ui-motionBody" +
