...
export class ImpairmentVisualizerControls extends React.Component<{}, IState> {
    ...
    private makeColorBlindnessOverlay(img: HTMLImageElement) {
        ...
        // Between 5.3 and 5.4 the zindex relationships in the overlay tool changed.
        // If this canvas is for a picture overlay, it'll need to be boosted slightly to be visible.
