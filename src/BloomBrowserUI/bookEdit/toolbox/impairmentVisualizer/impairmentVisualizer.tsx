...
// which  passes an instance of ImpairmentVisualizerToolAdaptor to ToolBox.registerTool();
...
export class ImpairmentVisualizerToolAdaptor extends ToolboxToolReactAdaptor {
