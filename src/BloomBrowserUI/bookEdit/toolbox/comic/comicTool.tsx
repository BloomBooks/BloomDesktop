...
const ComicToolControls: React.FunctionComponent = () => {
    ...
    const [newPageCount, setNewPageCount] = useState(0); // This counter increments on new page ready so we can re-check if the book is locked.
    ...
    ComicTool.theOneComicTool!.callOnNewPageReady = () => {
        ...
        const count = newPageCount;
        setNewPageCount(count + 1);
    };
