...
const ComicToolControls: React.FunctionComponent = () => {
    ...
    type possibleBubbleTypes = "text" | "image" | "video" | undefined;
    ...
    const [bubbleType, setBubbleType] = useState<possibleBubbleTypes>(
        undefined
    );
    ...
    // rule about not changing the number of hooks rendered. This is even more important now that we
    // don't show this part of the UI sometimes (BL-9976)!
    ...
    const showMainControls = bubbleType !== "video" && bubbleType !== "image";
            ...
            >
                {showMainControls ? (
                    ...
                    <div id="videoOrImageSubstituteSection">
                        ...
                        {bubbleType === "video" && (
                            <Button onClick={showSignLanguageTool} size="small">
