...
describe("talking book tests", () => {
    ...
    describe("- tests for sentence splitting", () => {
        ...
        it("[Sentence/Sentence] showTool() doesn't but updateMarkup() will update sentence splits if recordings do exist", async done => {
            try {
        ...
        it("[TextBox/Sentence] showTool() doesn't but updateMarkup() will update sentence splits if recordings do exist", async done => {
            try {
                await runSentenceSplitTestsForUpdateMarkupAsync(
        ...
        it("[TextBox/TextBox] showTool() doesn't but updateMarkup() will update sentence splits if recordings do exist", async done => {
            try {
                await runSentenceSplitTestsForUpdateMarkupAsync(
                    AudioMode.PureTextBox,
                    true
        ...
        it("[TextBox/Sentence Hard Split] showTool() doesn't but updateMarkup() will update sentence splits if recordings do exist", async done => {
            try {
                await runSentenceSplitTestsForUpdateMarkupAsync(
                    AudioMode.HardSplitTextBox,
                    true
        ...
        it("[TextBox/Sentence Soft Split] showTool() doesn't but updateMarkup() will update sentence splits if recordings do exist", async done => {
            try {
                await runSentenceSplitTestsForUpdateMarkupAsync(
                    AudioMode.SoftSplitTextBox,
                    true
