...
export default class AudioRecording {
    ...
    private isRecordingExistsForCurrentSelection(): boolean {
        return document
    ...
    public updateRecordingMode(forceOverwrite: boolean = false) {
        ...
        if (!forceOverwrite && this.isRecordingExistsForCurrentSelection()) {
            if (
        ...
        ReactDOM.render(
            React.createElement(
                BloomButton,
                {
                    ...
                    startIcon: React.createElement(ImportIcon),
                    hasText: true,
                    variant: "text",
                    size: "small",
    ...
    private handleImportRecordingClick(): void {
        if (this.isRecordingExistsForCurrentSelection()) {
