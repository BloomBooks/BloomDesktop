...
export default class AudioRecording {
    ...
    public getCurrentTextBox(): HTMLElement | null {
        ...
        if (audioCurrentElements.length === 0) {
            ...
            // TODO: Theoretically, we should await this.
            // That means all the callers should be async'ify'd, which is like... everything. :(
            // The only async part is if you try to fallback by setting the current audio element
            // So there is this version, and also a true snchronous version of this function called getCurrentTextBoxSync
            this.setCurrentAudioElementToFirstAudioElementAsync();
    ...
    // Entry point for TalkingBookTool's showTool(). Calls updateMarkup
