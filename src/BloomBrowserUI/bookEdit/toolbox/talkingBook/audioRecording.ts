...
export default class AudioRecording {
    ...
    // (Typically, the function will be excuted immediately unless the user has further edited the document in the meantime.)
    ...
    // To facilitate dynamic updates during typing, this doesn't actually change the elements itself.
    // Rather, it returns a function which, if no further keystrokes have been received or we
    // are not responding to typing, should be exectued immediately to make the change.
