...
export default class AudioRecording implements IAudioRecorder {
    ...
    private isVisible(
        ...
        if (transgroup) {
            ...
            // This check may be redundant, since when the image descriptions are hidden with display:none we detect
            // that in EditableDivUtils.isInHiddenLanguageBlock() above
            if (
