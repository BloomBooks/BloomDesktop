...
export default class AudioRecording {
    ...
    // Determines which element should receive the Current Highlight and moves the Current Highlight to it, if necessary
    ...
    private updateCurrentDivAsync(doneCallback?: () => void): void {
        ...
        if (
            ...
            // If we enter this if condition, we know we should move the Current Highlight onto the actively focused element.
            ...
            // Else: No need to move the Current Highlight off its previous value. So just call the doneCallback and then return.
            if (doneCallback) {
                doneCallback();
            }
        }
