...
//Given an initial guess at the sentence breaks, this method looks for the quietest point near each projected break
...
//Consider whether swapping out that evaluation function would improve our algorithm's accuracy
