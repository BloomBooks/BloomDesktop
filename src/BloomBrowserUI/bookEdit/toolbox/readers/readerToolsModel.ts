    ...
    beginSetTextsList(textsArg: string[]): Promise<void> {
        ...
        return this.beginGetAllSampleFiles().then(() => {
            ...
            setTimeout(() => {
                ...
                BloomApi.postD("api/readers/io/synphonyLanguageData", theOneLanguageDataInstance);
            }, 200);
        });
    }
    ...
    getAllowedWordsLists(): void {
        ...
        stages.forEach((stage, index) => {
            ...
            if (stage.allowedWordsFile) {
                BloomApi.getP("api/readers/io/allowedWordsList", { params: { 'fileName': stage.allowedWordsFile } },
