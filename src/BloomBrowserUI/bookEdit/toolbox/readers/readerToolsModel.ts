...
export class ReaderToolsModel {
    ...
    public displayBookTotals(): void {
        ...
        this.updateActualCount(
            this.averageWordsInPage(sentenceFragmentsByPage),
            this.maxAverageWordsPerPage(),
            "actualAverageWordsPerPage"
        );
        this.updateActualCount(
            this.averageGlyphsInWord(sentenceFragmentsByPage),
            this.maxAverageGlyphsPerWord(),
            "actualAverageGlyphsPerWord"
        );
        this.updateActualCount(
            this.averageSentencesInPage(sentenceFragmentsByPage),
    ...
    public static getWordLength(word: string): number {
        ...
        console.log("without diacritics: " + w);
        ...
        console.log("known graphemes: " + JSON.stringify(knownGraphemes));
