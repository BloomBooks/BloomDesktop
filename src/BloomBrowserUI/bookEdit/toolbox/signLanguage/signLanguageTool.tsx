...
> {
        ...
        return (
            <div id="trimWrapper">
                <VideoTrimSlider
                    ...
                    onChangeFunc={this.handleSliderRangeChange}
                    onAfterChangeFunc={this.handleSliderRangeAfterChange}
                />
    ...
    public componentDidMount() {
        // BL-6827 All this time this enterprise state was NOT being set!
        // Turns out it was vital to correct behavior.
        checkIfEnterpriseAvailable().then(enabled => {
