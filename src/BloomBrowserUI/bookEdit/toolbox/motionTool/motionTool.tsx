...
export class MotionTool implements ITool {
    ...
    public newPageReady() {
        // We don't much expect people to be editing the book and configuring background music
        // at the same time, so we'll just do this stuff when the page switches.
