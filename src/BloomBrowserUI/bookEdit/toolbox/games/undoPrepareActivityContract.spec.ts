...
// during play mode. That workaround is gone -- 2.20.3-alpha.1 has the fix -- and this is what
// replaced it. It deliberately does NOT skip on an older bloom-player: a contract the save path
// depends on is not optional, and a dependency that stopped meeting it should fail here rather
// than pass quietly.
...
describe("what the save path needs from bloom-player's undoPrepareActivity", () => {
    beforeEach(() => {
        document.body.innerHTML = "";
    });
