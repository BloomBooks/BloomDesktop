...
import { BloomEnterpriseIconWithTooltipAndDialog } from "../../../react_components/requiresSubscription";
...
const ToolboxCheckbox: FunctionComponent<{
    ...
    const [checked, setChecked] = useState<boolean>(
        isToolEnabledInToolbox(
            props.tool.indexOf("Visualizer") === -1
                ? props.tool + "Tool"
                : props.tool,
        ),
    );
        ...
        >
            ...
            {props.requiresSubscription && (
                <div
                    ...
                    `}
                >
                    <BloomEnterpriseIconWithTooltipAndDialog
...
export const ToolboxSettingsControls: FunctionComponent = () => {
    return (
