...
export const GamePromptDialog: React.FunctionComponent<IGamePromptDialogProps> = props => {
    ...
    return (
        <BloomDialog
            ...
            // See comment in onClick_DEPRECATED for why we don't have onCancel here.
        >
            ...
            <DialogBottomButtons>
                ...
                <DialogCancelButton
                    onClick_DEPRECATED={() => {
                        // Using the deprecated onClick of the cancel button rather than putting
                        // onCancel on the BloomDialog element because
                        // (a) we don't want an X button in the top right
                        // (b) we want a click on the backdrop or pressing ESC to close the dialog
                        // WITHOUT canceling the changes in the page.
                        cancel();
                        props.setOpen(false);
                    }}
                />
