...
function MakeBigger() {
    ...
    editor.MakeBigger(target[0]);
}
function MakeBigger2(target) {
    var jQueryTarget = $(document).find(target);
    var editor = new StyleEditor('file://' + "C:/dev/Bloom/src/BloomBrowserUI/bookEdit");
    editor.MakeBigger(jQueryTarget[0]);
}
function MakeSmaller(target) {
    var jQueryTarget = $(document).find(target);
    var editor = new StyleEditor('file://' + "C:/dev/Bloom/src/BloomBrowserUI/bookEdit");
    editor.MakeSmaller(jQueryTarget[0]);
}
function GetFontSize(target) {
    var jQueryTarget = $(document).find(target);
    var editor = new StyleEditor('file://' + "C:/dev/Bloom/src/BloomBrowserUI/bookEdit");
    return editor.GetCalculatedFontSizeInPoints(jQueryTarget[0]);
}
function ChangeSizeAbsolute(target, newSize) {
    var jQueryTarget = $(document).find(target);
    var editor = new StyleEditor('file://' + "C:/dev/Bloom/src/BloomBrowserUI/bookEdit");
    editor.ChangeSizeAbsolute(jQueryTarget[0], newSize);
}
...
function GetCalculatedFontSize(target) {
    var jQueryTarget = $(document).find(target);
    var editor = new StyleEditor('file://' + "C:/dev/Bloom/src/BloomBrowserUI/bookEdit");
    return editor.GetCalculatedFontSizeInPoints(jQueryTarget[0]);
}
