...
export const TopBarContextMenu: React.FunctionComponent<{
    ...
    useMountEffect(() => {
        // Only AlwaysMeasurePerformance persists independently of this menu.
        // The other two booleans are only turned on from this menu, so local state
        // can own them once we establish the initial persisted setting.
