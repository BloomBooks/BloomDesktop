...
// other than in the TeamCollectinBookStatusPanel, we'll probably need more generalized
...
export const IconHeadingBodyMenu: React.FunctionComponent<{
    title: string;
    subTitle: string;
    icon: JSX.Element;
        ...
        >
            ...
            >
                ...
                <Typography
                    ...
                    variant="subtitle2"
                >
                    <StringWithOptionalLink message={props.subTitle} />
                </Typography>
            </div>
            <div
                css={css`
