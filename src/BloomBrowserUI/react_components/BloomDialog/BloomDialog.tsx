...
export const BloomDialog: React.FunctionComponent<IBloomDialogProps> = props => {
    ...
    const { className: classNameForEmotionCssFromParent, ...rest } = props;
    const inner = (
        <div
            css={css`
            ...
            `}
            className={classNameForEmotionCssFromParent} // any css from the parent
        >
            {props.children}
        </div>
    );
        ...
        return (
            ...
            >
                <Paper
                    ...
                    `}
                    {...paperProps}
                    // Any css from the parent. This is used to control the height in a way that works
                    // reliably in gfx60 (with modern browsers height can be on the inner div instead
                    //className={classNameForEmotionCssFromParent}
                />
            </Draggable>
        );
    };
