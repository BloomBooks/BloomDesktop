...
// 1. Create a bloom-component.config.ts file in your component's folder (or e2e subfolder)
...
// Use Vite's import.meta.glob to automatically discover all bloom-component.config.ts files
// The pattern must be relative to this file's location
// This file is in: component-tester/component-registry.ts
// We want to find: */bloom-component.config.ts and */e2e/bloom-component.config.ts
...
}>(["../**/bloom-component.config.ts"], { eager: true });
