...
- [ ] after selecting a book, it should be possible to use the paste button to change the url. This should lead to the deselection of the book and page and the url being what was on the clipboard. Cover this is in ui tests.
