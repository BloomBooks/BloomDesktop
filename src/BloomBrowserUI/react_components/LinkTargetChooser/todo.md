...
- [ ] after selecting a book, it should be possible to use the paste button to change the url. This should lead to the deselection of the book and page and the url being what was on the clipboard. Cover this is in ui tests. (Blocked: paste clears the DOM in the Playwright harness—URL input disappears after `handlePaste`; still investigating.)
...
# Later
- [ ] We cannot really link to an xmatter pages because their id is new every morning. So, we should disable xmatter pages except for the cover.
