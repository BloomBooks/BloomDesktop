...
export default class BookMetadataTable extends React.Component<IProps> {
    ...
    private makeSubjectChooser() {
        const currentSubjects = " " + this.props.metadata.subjects.value + " ";
        this.MarkSelectedSubjectNodes(themaSubjectData, currentSubjects);
    ...
    private handleSubjectChange(
        ...
        selectedNodes: SubjectTreeNode[] // not useful for our purposes
    ) {
        let subjects: string;
    ...
    private MarkSelectedSubjectNodes(
