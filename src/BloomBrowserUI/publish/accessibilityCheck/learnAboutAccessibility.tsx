...
> {
    public render() {
        return (
            <div>
                <div style={{ width: "5in" }}>
                    <P l10nKey="AccessibilityCheck.LearnAbout.AccessibleBookDefinition">
                            ...
                            <ul>
                                <li>
                                    <String l10nKey="AccessibilityCheck.LearnAbout.AccessibilityCheckList">
                                        <b>The Accessibility Checklist</b> which
                                        is where Bloom checks over your book and
                                ...
                                <li>
                                    <String l10nKey="AccessibilityCheck.LearnAbout.AceByDaisyChecker">
                                        <b>The Ace by Daisy Checker</b> searches
                                        the actual ePUB generated by Bloom
