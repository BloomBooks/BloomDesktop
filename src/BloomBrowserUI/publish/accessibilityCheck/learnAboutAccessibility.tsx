            ...
            <div>
                <div style={{ width: "5in" }}>
                    <p>
                        ...
                        with impaired vision. With the ePUB standard, it is
                        possible to make <em>Born Accessible</em> books that
                        work well for everyone<sup>*</sup>, regardless of
                        vision. Bloom has the following tools to help you create
                        these books:
                    </p>
                    <ul>
                        <li>
                        ...
                        <li>
                            <HelpLink
                                ...
                                helpId="Tasks/Edit_tasks/Record_Audio/Using_the_Talking_Book_Tool.htm"
                            >
                                Talking Book Tool
                            </HelpLink>
                        </li>
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <b>The Ace by Daisy Checker</b> searched the
