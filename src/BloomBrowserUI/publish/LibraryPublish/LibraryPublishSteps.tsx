    ...
    return (
        <BloomStepper orientation="vertical">
            <Step active={true} completed={isReadyForUpload}>
                ...
                <StepContent>
                    <ReadonlyDataField labelText="Title">
                        my book title
                    </ReadonlyDataField>
                    <TextField
                        ...
                        `}
                    />
                    <ReadonlyDataField labelText="Copyright">
                        Copyright 2019 Napil National Language Preservation
                        Institute
                    </ReadonlyDataField>
                    <ReadonlyDataField labelText="Usage/License">
                ...
                <StepContent>
                    ...
                    >
                        <BloomButton
                            ...
                            onClick={() => setIsUploadComplete(true)}
                        >
                            Upload
                        </BloomButton>
                        <BloomButton
                    ...
                    <div
                        ...
                        `}
                    >
                        <Div l10nKey={""} temporarilyDisableI18nWarning={true}>
                            Upload Progress
                        </Div>
                        <ProgressBox
                            css={css`
            ...
            >
                ...
                <StepContent>
                    ...
                    <P l10nKey={""} temporarilyDisableI18nWarning={true}>
...
const Agreements: React.FunctionComponent<{
    ...
    function handleChange(isChecked: boolean) {
        setNumChecked(isChecked ? numChecked + 1 : numChecked - 1);
    }
    return (
        <React.Fragment>
            <AgreementCheckbox
...
const ReadonlyDataField: React.FunctionComponent<{
    labelText: string;
}> = props => {
    return (
        <div
