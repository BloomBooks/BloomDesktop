...
interface IReadonlyBookInfo {
    ...
    isTemplate: boolean;
    titleOKToPublish: boolean; // This will be false if there is no L1 title, unless we don't need languages.
}
...
export const LibraryPublishSteps: React.FunctionComponent = () => {
    ...
    const getTitleBlock = () => {
        ...
        if (!bookInfo.title || !bookInfo.titleOKToPublish) {
            return (
                <MissingInfo
                    text="Missing Title"
