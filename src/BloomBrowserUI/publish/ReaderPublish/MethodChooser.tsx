                ...
                <>
                    ...
                    >
                        <LocalizedString
                            ...
                            l10nComment="The 3 links should be left untranslated as well as the file type 'bloompub'."
                        >
                            You can use SD cards and sharing apps like email,
                            Google Drive, and WhatsApp to get your bloompub file
                            onto a device that has{" "}
