...
class AndroidPublishUI extends React.Component<IUILanguageAwareProps, IComponentState> {
    ...
    render() {
        let self = this;
        let colors: string[] = ["#E48C84", "#B0DEE4", "#98D0B9", "#C2B6AF", "#FF6900", "#FCB900", "#7BDCB5", "#00D084", "#8ED1FC", "#0693E3", "#ABB8C3", "#EB144C", "#F78DA7", "#9900EF"];


        return (
            <div>
                <H1 className="media-heading" l10nKey="PublishTab.Android.Media"
                    l10nComment="The top heading in the publish to Android tab. Thumbnail color and what audio and fonts to include">
                    Media
                </H1>
