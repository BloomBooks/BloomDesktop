...
import { H1, H2, LocalizableElement, IUILanguageAwareProps, Para } from "../../react_components/l10n";
    ...
    render() {
        ...
        return (
            <div>
                ...
                <Para l10nKey="Publish.Android.ReceiveOnDevice"
                    hidden={this.state.stateId !== "ServingOnWifi"}>
                    To start a transfer, run BloomReader, tap the icon in the top left of the screen, and choose "Get Books from Desktop."
