...
export const EnterpriseNeededScreen: React.FunctionComponent<{
    ...
    numberOfFirstPageWithOverlay: number;
}> = props => {
    ...
    const needsEnterpriseText3 = useL10n(
        ...
        "",
        "" + props.numberOfFirstPageWithOverlay
    );
...
export const PublishTabPane: React.FunctionComponent<{}> = () => {
    const waitForUserToChooseTabIndex = 5;
    const audioVideoTabIndex = 3;
    ...
    const [tabIndex, setTabIndex] = React.useState(waitForUserToChooseTabIndex);
    const setup = () => {
        setTabIndex(5);
                    ...
                    {!publishTabReady ? (
                        ...
                        <BloomTabs
                            ...
                            onSelect={newIndex => {
                                ...
                                if (
                                    tabIndex === audioVideoTabIndex &&
                                    newIndex != audioVideoTabIndex
                                ) {
