...
is a copy of the backend in **BloomBooks/bloom-core-supabase**, taken at commit **b0aadaa**
("Lock books in members_remove; make provisioning work on PS 5.1 (BL-16531)"). It is here only so the client's live tests and the E2E harness
