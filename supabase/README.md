...
is a copy of the backend in **BloomBooks/bloom-core-supabase**, taken at commit **0c61d63**
("Test that finish refuses a book deleted after start (BL-16531)"). It is here only so the client's live tests and the E2E harness
