...
document.write('<script type="text/javascript" src="' + lib + 'lib/jquery-ui.js"></script>');//nb: we just rename whatever version of jqueryui we have to this.
document.write('<link rel="stylesheet" type="text/css" href="' + lib + 'css/bloom-theme/jquery-ui-1.8.16.custom.css"></script>');
...
document.write('<link rel="stylesheet" type="text/css" lib="' + dir + 'jquery.qtip.css"></script>');
