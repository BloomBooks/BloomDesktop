...
This release is a stepping stone for a more complete set of features for making books for the visual and hearing impairments. These features are marked as:
...
-   Accessibility for people with visual impairments (Experimental, Bloom Enterprise)
