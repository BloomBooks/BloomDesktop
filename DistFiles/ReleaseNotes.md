...
- Edit Tab
    ...
    - When you make books from a shellbook, Bloom now moves the original copyright and license to its own field. Thus preserved, you can now set your own copyright and license for the adaptation. Bloom does not yet verify that the new license is compatible with the original.
    - Text Box Formatting (under "Change Layout")
        ...
        - We have moved borders and background color from the text styles to the Text Box Formatting
