...
![](https://docs.bloomlibrary.org/notion_imgs/828771189.png)

### Text Color

To highlight a word or some characters, you can now select some text and set its color.

![](https://docs.bloomlibrary.org/notion_imgs/40690727.png)
...
![](https://docs.bloomlibrary.org/notion_imgs/1609889616.png)

![](https://docs.bloomlibrary.org/notion_imgs/650834425.png)
...
![](https://docs.bloomlibrary.org/notion_imgs/890405378.png)

![](https://docs.bloomlibrary.org/notion_imgs/508774689.png)

## Team Collection: Single Book History

![](https://docs.bloomlibrary.org/notion_imgs/237292769.png)
...
![](https://docs.bloomlibrary.org/notion_imgs/12120676.png)

Less-used commands are now under a “More” submenu. In the future, we intend to simplify this further.

![](https://docs.bloomlibrary.org/notion_imgs/1248715891.png)

## BloomLibrary.org

Project cards can now have country names:

![](https://docs.bloomlibrary.org/notion_imgs/500617665.png)

We added a map showing where the collection is being read:

![](https://docs.bloomlibrary.org/notion_imgs/425378885.png)

And finally, we added city and country tables:

![](https://docs.bloomlibrary.org/notion_imgs/1842141498.png)
